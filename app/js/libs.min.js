! function(t) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], t) : "undefined" != typeof exports ? module.exports = t(require("jquery")) : t(jQuery) }(function(c) {
    ...
    s = 0, (a = function(t, e) {
    ...
    }).prototype.activateADA = function() { this.$slideTrack.find(".slick-active").attr({ "aria-hidden": "false" }).find("a, input, button, select").attr({ tabindex: "0" }) }, a.prototype.addSlide = a.prototype.slickAdd = function(t, e, i) {
        var o = this;
    ...
    }, a.prototype.getNavTarget = function() { var t = this.options.asNavFor; return t && null !== t && (t = c(t).not(this.$slider)), t }, a.prototype.asNavFor = function(e) {
    ...
    }, a.prototype.autoPlayClear = function() { this.autoPlayTimer && clearInterval(this.autoPlayTimer) }, a.prototype.autoPlayIterator = function() {
        var t = this,
            e = t.currentSlide + t.options.slidesToScroll;
        t.paused || t.interrupted || t.focussed || (!1 === t.options.infinite && (1 === t.direction && t.currentSlide + 1 === t.slideCount - 1 ? t.direction = 0 : 0 === t.direction && (e = t.currentSlide - t.options.slidesToScroll, t.currentSlide - 1 == 0 && (t.direction = 1))), t.slideHandler(e))
    }, a.prototype.buildArrows = function() { var t = this;!0 === t.options.arrows && (t.$prevArrow = c(t.options.prevArrow).addClass("slick-arrow"), t.$nextArrow = c(t.options.nextArrow).addClass("slick-arrow"), t.slideCount > t.options.slidesToShow ? (t.$prevArrow.removeClass("slick-hidden").removeAttr("aria-hidden tabindex"), t.$nextArrow.removeClass("slick-hidden").removeAttr("aria-hidden tabindex"), t.htmlExpr.test(t.options.prevArrow) && t.$prevArrow.prependTo(t.options.appendArrows), t.htmlExpr.test(t.options.nextArrow) && t.$nextArrow.appendTo(t.options.appendArrows), !0 !== t.options.infinite && t.$prevArrow.addClass("slick-disabled").attr("aria-disabled", "true")) : t.$prevArrow.add(t.$nextArrow).addClass("slick-hidden").attr({ "aria-disabled": "true", tabindex: "-1" })) }, a.prototype.buildDots = function() {
        var t, e, i = this;
    ...
    }, a.prototype.clickHandler = function(t) {!1 === this.shouldClick && (t.stopImmediatePropagation(), t.stopPropagation(), t.preventDefault()) }, a.prototype.destroy = function(t) {
        var e = this;
    ...
    }, a.prototype.fadeSlide = function(t, e) { var i = this;!1 === i.cssTransitions ? (i.$slides.eq(t).css({ zIndex: i.options.zIndex }), i.$slides.eq(t).animate({ opacity: 1 }, i.options.speed, i.options.easing, e)) : (i.applyTransition(t), i.$slides.eq(t).css({ opacity: 1, zIndex: i.options.zIndex }), e && setTimeout(function() { i.disableTransition(t), e.call() }, i.options.speed)) }, a.prototype.fadeSlideOut = function(t) { var e = this;!1 === e.cssTransitions ? e.$slides.eq(t).animate({ opacity: 0, zIndex: e.options.zIndex - 2 }, e.options.speed, e.options.easing) : (e.applyTransition(t), e.$slides.eq(t).css({ opacity: 0, zIndex: e.options.zIndex - 2 })) }, a.prototype.filterSlides = a.prototype.slickFilter = function(t) {
        var e = this;
    ...
    }, a.prototype.getCurrent = a.prototype.slickCurrentSlide = function() { return this.currentSlide }, a.prototype.getDotCount = function() {
        var t = this,
            e = 0,
            i = 0,
            o = 0;
    ...
    }, a.prototype.getOption = a.prototype.slickGetOption = function(t) { return this.options[t] }, a.prototype.getNavigableIndexes = function() {
        var t, e = this,
            i = 0,
            o = 0,
            s = [];
        ...
        return s
    }, a.prototype.getSlick = function() { return this }, a.prototype.getSlideCount = function() { var i, o, s = this; return o = !0 === s.options.centerMode ? s.slideWidth * Math.floor(s.options.slidesToShow / 2) : 0, !0 === s.options.swipeToSlide ? (s.$slideTrack.find(".slick-slide").each(function(t, e) { if (e.offsetLeft - o + c(e).outerWidth() / 2 > -1 * s.swipeLeft) return i = e, !1 }), Math.abs(c(i).attr("data-slick-index") - s.currentSlide) || 1) : s.options.slidesToScroll }, a.prototype.goTo = a.prototype.slickGoTo = function(t, e) { this.changeSlide({ data: { message: "index", index: parseInt(t) } }, e) }, a.prototype.init = function(t) {
        var e = this;
    ...
    }, a.prototype.initUI = function() { var t = this;!0 === t.options.arrows && t.slideCount > t.options.slidesToShow && (t.$prevArrow.show(), t.$nextArrow.show()), !0 === t.options.dots && t.slideCount > t.options.slidesToShow && t.$dots.show() }, a.prototype.keyHandler = function(t) {
        var e = this;
    ...
    }, a.prototype.next = a.prototype.slickNext = function() { this.changeSlide({ data: { message: "next" } }) }, a.prototype.orientationChange = function() { this.checkResponsive(), this.setPosition() }, a.prototype.pause = a.prototype.slickPause = function() { this.autoPlayClear(), this.paused = !0 }, a.prototype.play = a.prototype.slickPlay = function() {
        var t = this;
        t.autoPlay(), t.options.autoplay = !0, t.paused = !1, t.focussed = !1, t.interrupted = !1
    }, a.prototype.postSlide = function(t) {
        var e = this;
        e.unslicked || (e.$slider.trigger("afterChange", [e, t]), e.animating = !1, e.slideCount > e.options.slidesToShow && e.setPosition(), e.swipeLeft = null, e.options.autoplay && e.autoPlay(), !0 === e.options.accessibility && (e.initADA(), e.options.focusOnChange && c(e.$slides.get(e.currentSlide)).attr("tabindex", 0).focus()))
    }, a.prototype.prev = a.prototype.slickPrev = function() { this.changeSlide({ data: { message: "previous" } }) }, a.prototype.preventDefault = function(t) { t.preventDefault() }, a.prototype.progressiveLazyLoad = function(t) {
        t = t || 1;
    ...
    }, a.prototype.setDimensions = function() { var t = this;!1 === t.options.vertical ? !0 === t.options.centerMode && t.$list.css({ padding: "0px " + t.options.centerPadding }) : (t.$list.height(t.$slides.first().outerHeight(!0) * t.options.slidesToShow), !0 === t.options.centerMode && t.$list.css({ padding: t.options.centerPadding + " 0px" })), t.listWidth = t.$list.width(), t.listHeight = t.$list.height(), !1 === t.options.vertical && !1 === t.options.variableWidth ? (t.slideWidth = Math.ceil(t.listWidth / t.options.slidesToShow), t.$slideTrack.width(Math.ceil(t.slideWidth * t.$slideTrack.children(".slick-slide").length))) : !0 === t.options.variableWidth ? t.$slideTrack.width(5e3 * t.slideCount) : (t.slideWidth = Math.ceil(t.listWidth), t.$slideTrack.height(Math.ceil(t.$slides.first().outerHeight(!0) * t.$slideTrack.children(".slick-slide").length))); var e = t.$slides.first().outerWidth(!0) - t.$slides.first().width();!1 === t.options.variableWidth && t.$slideTrack.children(".slick-slide").width(t.slideWidth - e) }, a.prototype.setFade = function() {
        var i, o = this;
        ...
        if (i = n.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"), n.$slides.eq(t).addClass("slick-current"), !0 === n.options.centerMode) {
            ...
            e = Math.floor(n.options.slidesToShow / 2), !0 === n.options.infinite && (e <= t && t <= n.slideCount - 1 - e ? n.$slides.slice(t - e + a, t + e + 1).addClass("slick-active").attr("aria-hidden", "false") : (o = n.options.slidesToShow + t, i.slice(o - e + 1 + a, o + e + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === t ? i.eq(i.length - 1 - n.options.slidesToShow).addClass("slick-center") : t === n.slideCount - 1 && i.eq(n.options.slidesToShow).addClass("slick-center")), n.$slides.eq(t).addClass("slick-center")
    ...
    }, a.prototype.interrupt = function(t) { t || this.autoPlay(), this.interrupted = t }, a.prototype.selectHandler = function(t) {
        ...
        else { if (c.options.autoplay && clearInterval(c.autoPlayTimer), s = o < 0 ? c.slideCount % c.options.slidesToScroll != 0 ? c.slideCount - c.slideCount % c.options.slidesToScroll : c.slideCount + o : o >= c.slideCount ? c.slideCount % c.options.slidesToScroll != 0 ? 0 : o - c.slideCount : o, c.animating = !0, c.$slider.trigger("beforeChange", [c, c.currentSlide, s]), n = c.currentSlide, c.currentSlide = s, c.setSlideClasses(c.currentSlide), c.options.asNavFor && (l = (l = c.getNavTarget()).slick("getSlick")).slideCount <= l.options.slidesToShow && l.setSlideClasses(c.currentSlide), c.updateDots(), c.updateArrows(), !0 === c.options.fade) return !0 !== i ? (c.fadeSlideOut(n), c.fadeSlide(s, function() { c.postSlide(s) })) : c.postSlide(s), void c.animateHeight();!0 !== i && c.slideCount > c.options.slidesToShow ? c.animateSlide(r, function() { c.postSlide(s) }) : c.postSlide(s) }
    }, a.prototype.startLoad = function() { var t = this;!0 === t.options.arrows && t.slideCount > t.options.slidesToShow && (t.$prevArrow.hide(), t.$nextArrow.hide()), !0 === t.options.dots && t.slideCount > t.options.slidesToShow && t.$dots.hide(), t.$slider.addClass("slick-loading") }, a.prototype.swipeDirection = function() { var t, e, i, o, s = this; return t = s.touchObject.startX - s.touchObject.curX, e = s.touchObject.startY - s.touchObject.curY, i = Math.atan2(e, t), (o = Math.round(180 * i / Math.PI)) < 0 && (o = 360 - Math.abs(o)), o <= 45 && 0 <= o || o <= 360 && 315 <= o ? !1 === s.options.rtl ? "left" : "right" : 135 <= o && o <= 225 ? !1 === s.options.rtl ? "right" : "left" : !0 === s.options.verticalSwiping ? 35 <= o && o <= 135 ? "down" : "up" : "vertical" }, a.prototype.swipeEnd = function(t) {
        var e, i, o = this;
    ...
    }, a.prototype.swipeMove = function(t) { var e, i, o, s, n, a, r = this; return n = void 0 !== t.originalEvent ? t.originalEvent.touches : null, !(!r.dragging || r.scrolling || n && 1 !== n.length) && (e = r.getLeft(r.currentSlide), r.touchObject.curX = void 0 !== n ? n[0].pageX : t.clientX, r.touchObject.curY = void 0 !== n ? n[0].pageY : t.clientY, r.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(r.touchObject.curX - r.touchObject.startX, 2))), a = Math.round(Math.sqrt(Math.pow(r.touchObject.curY - r.touchObject.startY, 2))), !r.options.verticalSwiping && !r.swiping && 4 < a ? !(r.scrolling = !0) : (!0 === r.options.verticalSwiping && (r.touchObject.swipeLength = a), i = r.swipeDirection(), void 0 !== t.originalEvent && 4 < r.touchObject.swipeLength && (r.swiping = !0, t.preventDefault()), s = (!1 === r.options.rtl ? 1 : -1) * (r.touchObject.curX > r.touchObject.startX ? 1 : -1), !0 === r.options.verticalSwiping && (s = r.touchObject.curY > r.touchObject.startY ? 1 : -1), o = r.touchObject.swipeLength, (r.touchObject.edgeHit = !1) === r.options.infinite && (0 === r.currentSlide && "right" === i || r.currentSlide >= r.getDotCount() && "left" === i) && (o = r.touchObject.swipeLength * r.options.edgeFriction, r.touchObject.edgeHit = !0), !1 === r.options.vertical ? r.swipeLeft = e + o * s : r.swipeLeft = e + o * (r.$list.height() / r.listWidth) * s, !0 === r.options.verticalSwiping && (r.swipeLeft = e + o * s), !0 !== r.options.fade && !1 !== r.options.touchMove && (!0 === r.animating ? (r.swipeLeft = null, !1) : void r.setCSS(r.swipeLeft)))) }, a.prototype.swipeStart = function(t) {
        var e, i = this;
    ...
    }, a.prototype.unslick = function(t) { this.$slider.trigger("unslick", [this, t]), this.destroy() }, a.prototype.updateArrows = function() {
        var t = this;
    ...
    }, a.prototype.visibility = function() { this.options.autoplay && (document[this.hidden] ? this.interrupted = !0 : this.interrupted = !1) }, c.fn.slick = function() {
        var t, e, i = this,
            o = arguments[0],
...
function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : "object" == typeof exports ? t(require("jquery")) : t(window.jQuery || window.Zepto) }(function(d) {
    function t() {}

    function h(t, e) { m.ev.on("mfp" + t + w, e) }

    function p(t, e, i, o) { var s = document.createElement("div"); return s.className = "mfp-" + t, i && (s.innerHTML = i), o ? e && e.appendChild(s) : (s = d(s), e && s.appendTo(e)), s }

    function u(t, e) { m.ev.triggerHandler("mfp" + t, e), m.st.callbacks && (t = t.charAt(0).toLowerCase() + t.slice(1), m.st.callbacks[t] && m.st.callbacks[t].apply(m, d.isArray(e) ? e : [e])) }

    function f(t) { return t === e && m.currTemplate.closeBtn || (m.currTemplate.closeBtn = d(m.st.closeMarkup.replace("%title%", m.st.tClose)), e = t), m.currTemplate.closeBtn }

    function n() { d.magnificPopup.instance || ((m = new t).init(), d.magnificPopup.instance = m) }
    ...
    t.prototype = {
        ...
        open: function(t) {
            ...
            if (!1 === t.isObj) {
                ...
                for (e = 0; e < o.length; e++)
                    if ((i = o[e]).parsed && (i = i.el[0]), i === t.el[0]) { m.index = e; break }
            ...
            if (!m.isOpen) {
                ...
                return m.isIE7 && (c += " mfp-ie7"), c && m._addClassToMFP(c), m.updateItemHTML(), u("BuildControls"), d("html").css(r), m.bgOverlay.add(m.wrap).prependTo(m.st.prependTo || d(document.body)), m._lastFocusedEl = document.activeElement, setTimeout(function() { m.content ? (m._addClassToMFP(x), m._setFocus()) : m.bgOverlay.addClass(x), g.on("focusin" + w, m._onFocusIn) }, 16), m.isOpen = !0, m.updateSize(a), u(y), t
            }
            m.updateItemHTML()
        },
        close: function() { m.isOpen && (u(c), m.isOpen = !1, m.st.removalDelay && !m.isLowIE && m.supportsTransition ? (m._addClassToMFP(i), setTimeout(function() { m._close() }, m.st.removalDelay)) : m._close()) },
        _close: function() {
            u(l);
            var t = i + " " + x + " ";
        ...
        updateSize: function(t) {
            ...
            m.fixedContentPos || m.wrap.css("height", m.wH), u("Resize")
        },
        updateItemHTML: function() {
            ...
            if (u("BeforeChange", [m.currItem ? m.currItem.type : "", e]), m.currItem = t, !m.currTemplate[e]) {
                ...
                u("FirstMarkupParse", i), m.currTemplate[e] = !i || d(i)
            }
            s && s !== t.type && m.container.removeClass("mfp-" + s + "-holder");
            var o = m["get" + e.charAt(0).toUpperCase() + e.slice(1)](t, m.currTemplate[e]);
            m.appendContent(o, e), t.preloaded = !0, u("Change", t), s = t.type, m.container.prepend(m.contentContainer), u("AfterChange")
        },
        ...
        _openClick: function(t, e, i) {
            if ((void 0 !== i.midClick ? i.midClick : d.magnificPopup.defaults.midClick) || !(2 === t.which || t.ctrlKey || t.metaKey || t.altKey || t.shiftKey)) {
                ...
                if (o)
                    if (d.isFunction(o)) { if (!o.call(m)) return !0 } else if (_.width() < o) return !0;
                t.type && (t.preventDefault(), m.isOpen && t.stopPropagation()), i.el = d(t.mfpEl), i.delegate && (i.items = e.find(i.delegate)), m.open(i)
            }
        },
        updateStatus: function(t, e) {
            if (m.preloader) {
                o !== t && m.container.removeClass("mfp-s-" + o), e || "loading" !== t || (e = m.st.tLoading);
                var i = { status: t, text: e };
                u("UpdateStatus", i), t = i.status, e = i.text, m.preloader.html(e), m.preloader.find("a").on("click", function(t) { t.stopImmediatePropagation() }), m.container.addClass("mfp-s-" + t), o = t
            }
        },
        _checkIfClose: function(t) {
            if (!d(t).hasClass(a)) {
                ...
                if (t === m.content[0] || d.contains(m.content[0], t)) { if (e) return !0 } else if (i && d.contains(document, t)) return !0;
                return !1
            }
        },
        _addClassToMFP: function(t) { m.bgOverlay.addClass(t), m.wrap.addClass(t) },
        _removeClassFromMFP: function(t) { this.bgOverlay.removeClass(t), m.wrap.removeClass(t) },
        _hasScrollBar: function(t) { return (m.isIE7 ? g.height() : document.body.scrollHeight) > (t || _.height()) },
        _setFocus: function() {
            (m.st.focus ? m.content.find(m.st.focus).eq(0) : m.wrap).focus()
        },
        _onFocusIn: function(t) { if (t.target !== m.wrap[0] && !d.contains(m.wrap[0], t.target)) return m._setFocus(), !1 },
        _parseMarkup: function(s, t, e) {
            var n;
            e.data && (t = d.extend(e.data, t)), u(b, [s, t, e]), d.each(t, function(t, e) { if (void 0 === e || !1 === e) return !0; if (1 < (n = t.split("_")).length) { var i = s.find(w + "-" + n[0]); if (0 < i.length) { var o = n[1]; "replaceWith" === o ? i[0] !== e[0] && i.replaceWith(e) : "img" === o ? i.is("img") ? i.attr("src", e) : i.replaceWith(d("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(n[1], e) } } else s.find(w + "-" + t).html(e) })
        },
        ...
        if ("string" == typeof t)
            if ("open" === t) {
                ...
                i = o.items ? o.items[s] : (i = e, o.delegate && (i = i.find(o.delegate)), i.eq(s)), m._openClick({ mfpEl: i }, e, o)
            } else m.isOpen && m[t].apply(m, Array.prototype.slice.call(arguments, 1));
        else t = d.extend(!0, {}, t), r ? e.data("magnificPopup", t) : e[0].magnificPopup = t, m.addGroup(e, t);
        return e
    };

    function C() { T && (k.after(T.addClass(S)).detach(), T = null) }
    var S, k, T, $ = "inline";
    d.magnificPopup.registerModule($, {
        options: { hiddenClass: "hide", markup: "", tNotFound: "Content not found" },
        proto: {
            initInline: function() { m.types.push($), h(l + "." + $, function() { C() }) },
            getInline: function(t, e) {
                if (C(), t.src) {
                    ...
                    if (o.length) {
                        ...
                        s && s.tagName && (k || (S = i.hiddenClass, k = p(S), S = "mfp-" + S), T = o.after(k).detach().removeClass(S)), m.updateStatus("ready")
                    } else m.updateStatus("error", i.tNotFound), o = d("<div>");
    ...
    function A() { I && d(document.body).removeClass(I) }

    function P() { A(), m.req && m.req.abort() }
    var I, O = "ajax";
    d.magnificPopup.registerModule(O, {
        options: { settings: null, cursor: "mfp-ajax-cur", tError: '<a href="%url%">The content</a> could not be loaded.' },
        proto: {
            initAjax: function() { m.types.push(O), I = m.st.ajax.cursor, h(l + "." + O, P), h("BeforeChange." + O, P) },
            getAjax: function(s) {
                ...
                var t = d.extend({
                    ...
                    success: function(t, e, i) {
                        var o = { data: t, xhr: i };
                        u("ParseAjax", o), m.appendContent(d(o.data), O), s.finished = !0, A(), m._setFocus(), setTimeout(function() { m.wrap.addClass(x) }, 16), m.updateStatus("ready"), u("AjaxContentAdded")
                    },
                    error: function() { A(), s.finished = s.loadError = !0, m.updateStatus("error", m.st.ajax.tError.replace("%url%", s.src)) }
                }, m.st.ajax.settings);
    ...
    d.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var t = m.st.image,
                    e = ".image";
                m.types.push("image"), h(y + e, function() { "image" === m.currItem.type && t.cursor && d(document.body).addClass(t.cursor) }), h(l + e, function() { t.cursor && d(document.body).removeClass(t.cursor), _.off("resize" + w) }), h("Resize" + e, m.resizeImage), m.isLowIE && h("AfterChange", m.resizeImage)
            },
            ...
            _onImageHasSize: function(t) { t.img && (t.hasSize = !0, E && clearInterval(E), t.isCheckingImgSize = !1, u("ImageHasSize", t), t.imgHidden && (m.content && m.content.removeClass("mfp-loading"), t.imgHidden = !1)) },
            findImageSize: function(e) {
                var i = 0,
                    o = e.img[0],
                    s = function(t) { E && clearInterval(E), E = setInterval(function() { 0 < o.naturalWidth ? m._onImageHasSize(e) : (200 < i && clearInterval(E), 3 === ++i ? s(10) : 40 === i ? s(50) : 100 === i && s(500)) }, t) };
                s(1)
            },
            getImage: function(t, e) {
                var i = 0,
                    o = function() { t && (t.img[0].complete ? (t.img.off(".mfploader"), t === m.currItem && (m._onImageHasSize(t), m.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, u("ImageLoadComplete")) : ++i < 200 ? setTimeout(o, 100) : s()) },
                    s = function() { t && (t.img.off(".mfploader"), t === m.currItem && (m._onImageHasSize(t), m.updateStatus("error", n.tError.replace("%url%", t.src))), t.hasSize = !0, t.loaded = !0, t.loadError = !0) },
                    n = m.st.image,
                    a = e.find(".mfp-img");
                if (a.length) {
                    var r = document.createElement("img");
                    r.className = "mfp-img", t.el && t.el.find("img").length && (r.alt = t.el.find("img").attr("alt")), t.img = d(r).on("load.mfploader", o).on("error.mfploader", s), r.src = t.src, a.is("img") && (t.img = t.img.clone()), 0 < (r = t.img[0]).naturalWidth ? t.hasSize = !0 : r.width || (t.hasSize = !1)
                }
                return m._parseMarkup(e, { title: function(t) { if (t.data && void 0 !== t.data.title) return t.data.title; var e = m.st.image.titleSrc; if (e) { if (d.isFunction(e)) return e.call(m, t); if (t.el) return t.el.attr(e) || "" } return "" }(t), img_replaceWith: t.img }, t), m.resizeImage(), t.hasSize ? (E && clearInterval(E), t.loadError ? (e.addClass("mfp-loading"), m.updateStatus("error", n.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), m.updateStatus("ready"))) : (m.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, e.addClass("mfp-loading"), m.findImageSize(t))), e
            }
        }
    });
    var D;
        ...
        proto: {
            initZoom: function() {
                ...
                if (n.enabled && m.supportsTransition) {
                    ...
                    function o() { m.content.css("visibility", "visible") }
                    ...
                    h("BuildControls" + e, function() {
                        if (m._allowZoom()) {
                            ...
                            (a = i(t)).css(m._getOffset()), m.wrap.append(a), s = setTimeout(function() { a.css(m._getOffset(!0)), s = setTimeout(function() { o(), setTimeout(function() { a.remove(), t = a = null, u("ZoomAnimationEnded") }, 16) }, r) }, 16)
                        }
                    }), h(c + e, function() {
                        if (m._allowZoom()) {
                    ...
                    }), h(l + e, function() { m._allowZoom() && (o(), a && a.remove(), t = null) })
                }
            },
            ...
            _getOffset: function(t) {
                ...
                var n = { width: e.width(), height: (r ? e.innerHeight() : e[0].offsetHeight) - s - o };
    ...
    d.magnificPopup.registerModule(M, {
        ...
        proto: {
            initIframe: function() { m.types.push(M), h("BeforeChange", function(t, e, i) { e !== i && (e === M ? F() : i === M && F(!0)) }), h(l + "." + M, function() { F() }) },
            getIframe: function(t, e) {
                var i = t.src,
                    o = m.st.iframe;
                d.each(o.patterns, function() { if (-1 < i.indexOf(this.index)) return this.id && (i = "string" == typeof this.id ? i.substr(i.lastIndexOf(this.id) + this.id.length, i.length) : this.id.call(this, i)), i = this.src.replace("%id%", i), !1 });
                var s = {};
    ...
    function R(t) { var e = m.items.length; return e - 1 < t ? t - e : t < 0 ? e + t : t }
    ...
    d.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                v += " mfp-gallery", h(y + t, function() { n.navigateByImgClick && m.wrap.on("click" + t, ".mfp-img", function() { if (1 < m.items.length) return m.next(), !1 }), g.on("keydown" + t, function(t) { 37 === t.keyCode ? m.prev() : 39 === t.keyCode && m.next() }) }), h("UpdateStatus" + t, function(t, e) { e.text && (e.text = N(e.text, m.currItem.index, m.items.length)) }), h(b + t, function(t, e, i, o) {
                    var s = m.items.length;
                    i.counter = 1 < s ? N(n.tCounter, o.index, s) : ""
                    ...
                    if (1 < m.items.length && n.arrows && !m.arrowLeft) {
                        ...
                        e.click(function() { m.prev() }), i.click(function() { m.next() }), m.container.append(e.add(i))
                    }
                }), h("Change" + t, function() { m._preloadTimeout && clearTimeout(m._preloadTimeout), m._preloadTimeout = setTimeout(function() { m.preloadNearbyImages(), m._preloadTimeout = null }, 16) }), h(l + t, function() { g.off(t), m.wrap.off("click" + t), m.arrowRight = m.arrowLeft = null })
            },
            next: function() { m.direction = !0, m.index = R(m.index + 1), m.updateItemHTML() },
            prev: function() { m.direction = !1, m.index = R(m.index - 1), m.updateItemHTML() },
            goTo: function(t) { m.direction = t >= m.index, m.index = t, m.updateItemHTML() },
            ...
            _preloadItem: function(t) {
                if (t = R(t), !m.items[t].preloaded) {
                    var e = m.items[t];
                    e.parsed || (e = m.parseEl(t)), u("LazyLoad", e), "image" === e.type && (e.img = d('<img class="mfp-img" />').on("load.mfploader", function() { e.hasSize = !0 }).on("error.mfploader", function() { e.hasSize = !0, e.loadError = !0, u("LazyLoadError", e) }).attr("src", e.src)), e.preloaded = !0
                }
            }
        }
    });
        ...
        proto: {
            initRetina: function() {
                if (1 < window.devicePixelRatio) {
                    var i = m.st.retina,
                        o = i.ratio;
                    1 < (o = isNaN(o) ? o() : o) && (h("ImageHasSize." + B, function(t, e) { e.img.css({ "max-width": e.img[0].naturalWidth / o, width: "100%" }) }), h("ElementParse." + B, function(t, e) { e.src = i.replaceSrc(e, o) }))
                }
            }
        }
    }), n()
...
function(p) {
    ...
    ! function() {
        ...
        void 0 === i.nextElementSibling && Object.defineProperty(p.Element.prototype, "nextElementSibling", {
        ...
        }), (t = p.Element.prototype).matches = t.matches || t.machesSelector || t.mozMatchesSelector || t.msMatchesSelector || t.oMatchesSelector || t.webkitMatchesSelector || function(t) { return -1 < Array.prototype.indexOf.call(this.parentElement.querySelectorAll(t), this) }, Object.keys || (Object.keys = (r = Object.prototype.hasOwnProperty, s = !{ toString: null }.propertyIsEnumerable("toString"), a = (n = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"]).length, function(t) {
            var e = [],
                i = "",
                o = -1;
            ...
            if (s)
                for (o = 0; o < a; o++) r.call(t, n[o]) && e.push(n[o]);
            return e
        })), Array.isArray || (Array.isArray = function(t) { return "[object Array]" === Object.prototype.toString.call(t) }), "function" != typeof Object.create && (Object.create = function(t, e) {
            ...
            return -1
        }), Function.prototype.bind || (Function.prototype.bind = function(t) { var e, i, o, s; if ("function" != typeof this) throw new TypeError; return e = Array.prototype.slice.call(arguments, 1), o = function() {}, s = function() { return i.apply(this instanceof o ? this : t, e.concat(Array.prototype.slice.call(arguments))) }, (i = this).prototype && (o.prototype = this.prototype), s.prototype = new o, s }), p.Element.prototype.dispatchEvent || (p.Element.prototype.dispatchEvent = function(t) { try { return this.fireEvent("on" + t.type, t) } catch (t) {} })
    }(), (u = function(t, e, i) {
        var o = null,
            s = !1,
            n = null,
        ...
        for (h = 0;
            (o = d[h]) && (!(0 < h) || s); h++) o.id ? c = o.id : (c = "MixItUp" + f.randomHex(), o.id = c), u.instances[c] instanceof u.Mixer ? (n = u.instances[c], (!e || e && e.debug && !1 !== e.debug.showWarnings) && console.warn(u.messages.warningFactoryPreexistingInstance())) : ((n = new u.Mixer).attach(o, r, c, e), u.instances[c] = n), a = new u.Facade(n), e && e.debug && e.debug.enable ? l.push(n) : l.push(a);
        return s ? new u.Collection(l) : l[0]
    }).use = function(t) { u.Base.prototype.callActions.call(u, "beforeUse", arguments), "function" == typeof t && "mixitup-extension" === t.TYPE ? void 0 === u.extensions[t.NAME] && (t(u), u.extensions[t.NAME] = t) : t.fn && t.fn.jquery && (u.libraries.$ = t), u.Base.prototype.callActions.call(u, "afterUse", arguments) }, u.instances = {}, u.extensions = {}, u.libraries = {}, f = {
        ...
        extend: function(e, t, i, o) {
            ...
            try {
                if (Array.isArray(t))
                    for (a = 0; a < t.length; a++) s.push(a);
                else t && (s = Object.keys(t));
                for (a = 0; a < s.length; a++) n = s[a], !i || "object" != typeof t[n] || this.isElement(t[n]) ? e[n] = t[n] : (Array.isArray(t[n]) ? e[n] || (e[n] = []) : e[n] || (e[n] = {}), this.extend(e[n], t[n], i, o))
            } catch (t) {
                if (!o) throw t;
        ...
        handleExtendError: function(t, e) {
            ...
            if (t instanceof TypeError && (i = /property "?(\w*)"?[,:] object/i.exec(t.message))) {
                ...
                throw 1 < l && (n = u.messages.errorConfigInvalidPropertySuggestion({ probableMatch: a })), s = u.messages.errorConfigInvalidProperty({ erroneous: o, suggestion: n }), new TypeError(s)
            }
            throw t
        },
        template: function(o) {
        ...
        on: function(t, e, i, o) { t && (t.addEventListener ? t.addEventListener(e, i, o) : t.attachEvent && (t["e" + e + i] = i, t[e + i] = function() { t["e" + e + i](p.event) }, t.attachEvent("on" + e, t[e + i]))) },
        off: function(t, e, i) { t && (t.removeEventListener ? t.removeEventListener(e, i, !1) : t.detachEvent && (t.detachEvent("on" + e, t[e + i]), t[e + i] = null)) },
        getCustomEvent: function(t, e, i) { var o = null; return i = i || p.document, "function" == typeof p.CustomEvent ? o = new p.CustomEvent(t, { detail: e, bubbles: !0, cancelable: !0 }) : "function" == typeof i.createEvent ? (o = i.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, e) : ((o = i.createEventObject()).type = t, o.returnValue = !1, o.cancelBubble = !1, o.detail = e), o },
        ...
        isElement: function(t, e) { return e = e || p.document, !!(p.HTMLElement && t instanceof p.HTMLElement) || (!!(e.defaultView && e.defaultView.HTMLElement && t instanceof e.defaultView.HTMLElement) || null !== t && 1 === t.nodeType && "string" == typeof t.nodeName) },
        ...
        arrayShuffle: function(t) { for (var e = t.slice(), i = e.length, o = i, s = -1, n = []; o--;) s = ~~(Math.random() * i), n = e[o], e[o] = e[s], e[s] = n; return e },
        arrayFromList: function(e) { var i, o; try { return Array.prototype.slice.call(e) } catch (t) { for (i = [], o = 0; o < e.length; o++) i.push(e[o]); return i } },
        debounce: function(s, n, a) {
            ...
            return function() {
                var t, e = this,
                    i = arguments,
                    o = a && !r;
                t = function() { r = null, a || s.apply(e, i) }, clearTimeout(r), r = setTimeout(t, n), o && s.apply(e, i)
            }
        },
        position: function(t) { for (var e = 0, i = 0, o = t; t;) e -= t.scrollLeft, i -= t.scrollTop, t === o && (e += t.offsetLeft, i += t.offsetTop, o = t.offsetParent), t = t.parentElement; return { x: e, y: i } },
        getHypotenuse: function(t, e) {
            var i = t.x - e.x,
                o = t.y - e.y;
            return i = i < 0 ? -1 * i : i, o = o < 0 ? -1 * o : o, Math.sqrt(Math.pow(i, 2) + Math.pow(o, 2))
        },
        getIntersectionRatio: function(t, e) { var i, o = t.width * t.height; return i = Math.max(0, Math.min(t.left + t.width, e.left + e.width) - Math.max(t.left, e.left)), Math.max(0, Math.min(t.top + t.height, e.top + e.height) - Math.max(t.top, e.top)) * i / o },
        ...
        defer: function(t) {
            var e = null,
                i = null,
                o = null;
            return i = new this.Deferred, u.features.has.promises ? i.promise = new Promise(function(t, e) { i.resolve = t, i.reject = e }) : (o = p.jQuery || t.$) && "function" == typeof o.Deferred ? (e = o.Deferred(), i.promise = e.promise(), i.resolve = e.resolve, i.reject = e.reject) : p.console && console.warn(u.messages.warningNoPromiseImplementation()), i
        },
        all: function(t, e) { var i = null; return u.features.has.promises ? Promise.all(t) : (i = p.jQuery || e.$) && "function" == typeof i.when ? i.when.apply(i, t).done(function() { return arguments }) : (p.console && console.warn(u.messages.warningNoPromiseImplementation()), []) },
        ...
        getDocumentState: function(t) { return t = "object" == typeof t.body ? t : p.document, { scrollTop: p.pageYOffset, scrollLeft: p.pageXOffset, docHeight: t.documentElement.scrollHeight, docWidth: t.documentElement.scrollWidth, viewportHeight: t.documentElement.clientHeight, viewportWidth: t.documentElement.clientWidth } },
        bind: function(t, e) { return function() { return e.apply(t, arguments) } },
        isVisible: function(t) { var e; return !!t.offsetParent || "fixed" === (e = p.getComputedStyle(t)).position && "hidden" !== e.visibility && "0" !== e.opacity },
        ...
        compareVersions: function(t, e) {
            var i = t.split("."),
                ...
                n = -1,
                a = -1;
            for (a = 0; a < i.length; a++) { if (s = parseInt(i[a].replace(/[^\d.]/g, "")), (n = parseInt(o[a].replace(/[^\d.]/g, "") || 0)) < s) return !1; if (s < n) return !0 }
            return !0
        },
        Deferred: function() { this.promise = null, this.resolve = null, this.reject = null, this.id = f.randomHex() },
        ...
        getClassname: function(t, e, i) { var o = ""; return (o += t.block).length && (o += t.delineatorElement), o += t["element" + this.pascalCase(e)], i ? (o.length && (o += t.delineatorModifier), o += i) : o },
        getProperty: function(t, e) {
            var i, o = e.split("."),
                s = "",
                n = 0;
            if (!e) return t;
            for (i = function(t) { return t ? t[s] : null }; n < o.length;) s = o[n], t = i(t), n++;
        ...
        this.actions = {}, this.filters = {}, this.extend = function(t) { f.extend(this.prototype, t) }, this.registerAction = function(t, e, i) {
            (this.actions[t] = this.actions[t] || {})[e] = i
        }, this.registerFilter = function(t, e, i) {
            (this.filters[t] = this.filters[t] || {})[e] = i
        }
    }, u.Features = function() { u.Base.call(this), this.callActions("beforeConstruct"), this.boxSizingPrefix = "", this.transformPrefix = "", this.transitionPrefix = "", this.boxSizingPrefix = "", this.transformProp = "", this.transformRule = "", this.transitionProp = "", this.perspectiveProp = "", this.perspectiveOriginProp = "", this.has = new u.Has, this.canary = null, this.BOX_SIZING_PROP = "boxSizing", this.TRANSITION_PROP = "transition", this.TRANSFORM_PROP = "transform", this.PERSPECTIVE_PROP = "perspective", this.PERSPECTIVE_ORIGIN_PROP = "perspectiveOrigin", this.VENDORS = ["Webkit", "moz", "O", "ms"], this.TWEENABLE = ["opacity", "width", "height", "marginRight", "marginBottom", "x", "y", "scale", "translateX", "translateY", "translateZ", "rotateX", "rotateY", "rotateZ"], this.callActions("afterConstruct") }, u.BaseStatic.call(u.Features), u.Features.prototype = Object.create(u.Base.prototype), f.extend(u.Features.prototype, {
        ...
        isBound: function(t) { var e; return this.callActions("beforeIsBound", arguments), e = -1 < this.bound.indexOf(t), this.callFilters("afterIsBound", e, arguments) },
        ...
        bindClick: function() {
            var e = this;
            this.callActions("beforeBindClick", arguments), e.handler = function(t) { e.handleClick(t) }, f.on(e.el, "click", e.handler), this.callActions("afterBindClick", arguments)
        },
        unbindClick: function() { this.callActions("beforeUnbindClick", arguments), f.off(this.el, "click", this.handler), this.handler = null, this.callActions("afterUnbindClick", arguments) },
            ...
            if (this.callActions("beforeHandleClick", arguments), this.pending = 0, o = e.bound[0], i = e.selector ? f.closestParent(t.target, o.config.selectors.control + e.selector, !0, o.dom.document) : e.el) {
                switch (e.type) {
                    ...
                    case "sort":
                        ...
                        break;
                    case "multimix":
                        n.filter = e.filter || i.getAttribute("data-filter"), n.sort = e.sort || i.getAttribute("data-sort");
                        break;
                    case "toggle":
                        n.filter = e.filter || i.getAttribute("data-toggle"), s = "live" === e.status ? f.hasClass(i, e.classNames.active) : "active" === e.status
                }
                for (l = 0; l < e.bound.length; l++) a = new u.CommandMultimix, f.extend(a, n), r.push(a);
                for (r = e.callFilters("commandsHandleClick", r, arguments), e.pending = e.bound.length, l = 0; o = e.bound[l]; l++)(n = r[l]) && (o.lastClicked || (o.lastClicked = i), u.events.fire("mixClick", o.dom.container, { state: o.state, instance: o, originalEvent: t, control: o.lastClicked }, o.dom.document), "function" == typeof o.config.callbacks.onMixClick && !1 === o.config.callbacks.onMixClick.call(o.lastClicked, o.state, t, o) || ("toggle" === e.type ? s ? o.toggleOff(n.filter) : o.toggleOn(n.filter) : o.multimix(n)));
            ...
            switch (s.callActions("beforeParseStatusChange", arguments), s.type) {
                ...
                case "toggle":
                    for (o.length < 1 && s.renderStatus(t, "inactive"), e.filter === i.filter && s.renderStatus(t, "active"), a = 0; a < o.length; a++) {
                        if (o[a] === i.filter) { s.renderStatus(t, "active"); break }
        ...
        indexTargets: function() {
            ...
            if (e.dom.targets.length) {
                for (s = 0; o = e.dom.targets[s]; s++)(i = new u.Target).init(o, e, t ? t[s] : void 0), i.isInDom = !0, e.targets.push(i);
        ...
        initControls: function() {
            ...
            for (r = 0; e = u.controlDefinitions[r]; r++)
                if (t.config.controls.live || e.live) { if (e.parent) { if (!(n = t.dom[e.parent]) || n.length < 0) continue; "number" != typeof n.length && (n = [n]) } else n = [s]; for (l = 0; o = n[l]; l++) a = t.getControl(o, e.type, e.selector), t.controls.push(a) } else
                    for (i = s.querySelectorAll(t.config.selectors.control + e.selector), l = 0; o = i[l]; l++)(a = t.getControl(o, e.type, "")) && t.controls.push(a);
        ...
        getControl: function(t, e, i) {
            ...
            if (o.callActions("beforeGetControl", arguments), !i)
                for (n = 0; s = u.controls[n]; n++) { if (s.el === t && s.isBound(o)) return o.callFilters("controlGetControl", null, arguments); if (s.el === t && s.type === e && s.selector === i) return s.addBinding(o), o.callFilters("controlGetControl", s, arguments) }
        ...
        filterOperation: function(t) {
            var e, i = !1,
                ...
                s = null,
                n = -1;
            for (this.callActions("beforeFilterOperation", arguments), e = t.newFilter.action, n = 0; s = t.newOrder[n]; n++) i = t.newFilter.collection ? -1 < t.newFilter.collection.indexOf(s.dom.el) : "" !== t.newFilter.selector && s.dom.el.matches(t.newFilter.selector), this.evaluateHideShow(i, s, e, t);
            if (t.toRemove.length)
                for (n = 0; s = t.show[n]; n++) - 1 < t.toRemove.indexOf(s) && (t.show.splice(n, 1), -1 < (o = t.toShow.indexOf(s)) && t.toShow.splice(o, 1), t.toHide.push(s), t.hide.push(s), n--);
        ...
        evaluateHideShow: function(t, e, i, o) {
            ...
            s = this.callFilters("testResultEvaluateHideShow", t, n), this.callActions("beforeEvaluateHideShow", arguments), !0 === s && "show" === i || !1 === s && "hide" === i ? (o.show.push(e), e.isShown || o.toShow.push(e)) : (o.hide.push(e), e.isShown && o.toHide.push(e)), this.callActions("afterEvaluateHideShow", arguments)
        },
        sortOperation: function(i) {
            ...
            if (o.callActions("beforeSortOperation", arguments), i.startOrder = o.targets, i.newSort.collection) {
                for (t = [], n = 0; s = i.newSort.collection[n]; n++) {
                    ...
                    (e = new u.Target).init(s, o), e.isInDom = !0, t.push(e)
                }
                i.newOrder = t
            } else "random" === i.newSort.order ? i.newOrder = f.arrayShuffle(i.startOrder) : "" === i.newSort.attribute ? (i.newOrder = o.origOrder.slice(), "desc" === i.newSort.order && i.newOrder.reverse()) : (i.newOrder = i.startOrder.slice(), i.newOrder.sort(function(t, e) { return o.compare(t, e, i.newSort) }));
        ...
        compare: function(t, e, i) {
            ...
            return n = isNaN(+s) || isNaN(+n) ? (s = s.toLowerCase(), n.toLowerCase()) : (s = +s, +n), s < n ? "asc" === o ? -1 : 1 : n < s ? "asc" === o ? 1 : -1 : s === n && i.next ? this.compare(t, e, i.next) : 0
        },
        getAttributeValue: function(t, e) { var i; return null === (i = t.dom.el.getAttribute("data-" + e)) && this.config.debug.showWarnings && console.warn(u.messages.warningInconsistentSortingAttributes({ attribute: "data-" + e })), this.callFilters("valueGetAttributeValue", i || 0, arguments) },
                ...
                switch (-1 < (n = e.indexOf(t + "(")) && (r = e.substring(n), l = /\(([^)]+)\)/.exec(r)[1]), t) {
                    ...
                    default:
                        if (s && a.config.animation.reverseOut && "scale" !== t ? i[t].value = -1 * (l ? parseFloat(l) : u.transformDefaults[t].value) : i[t].value = l ? parseFloat(l) : u.transformDefaults[t].value, l) {
                            for (h = 0; d = c[h]; h++)
                                if (-1 < l.indexOf(d)) { i[t].unit = d; break }
        ...
        goMix: function(t, e) {
            var i = this,
                o = null;
            return i.callActions("beforeGoMix", arguments), i.config.animation.duration && i.config.animation.effects && f.isVisible(i.dom.container) || (t = !1), e.toShow.length || e.toHide.length || e.willSort || e.willChangeLayout || (t = !1), e.startState.show.length || e.show.length || (t = !1), u.events.fire("mixStart", i.dom.container, { state: e.startState, futureState: e.newState, instance: i }, i.dom.document), "function" == typeof i.config.callbacks.onMixStart && i.config.callbacks.onMixStart.call(i.dom.container, e.startState, e.newState, i), f.removeClass(i.dom.container, f.getClassname(i.config.classNames, "container", i.config.classNames.modifierFailed)), o = i.userDeferred ? i.userDeferred : i.userDeferred = f.defer(u.libraries), i.isBusy = !0, t && u.features.has.transitions ? (p.pageYOffset !== e.docState.scrollTop && p.scrollTo(e.docState.scrollLeft, e.docState.scrollTop), i.config.animation.applyPerspective && (i.dom.parent.style[u.features.perspectiveProp] = i.config.animation.perspectiveDistance, i.dom.parent.style[u.features.perspectiveOriginProp] = i.config.animation.perspectiveOrigin), i.config.animation.animateResizeContainer && e.startHeight !== e.newHeight && e.viewportDeltaY !== e.startHeight - e.newHeight && (i.dom.parent.style.height = e.startHeight + "px"), i.config.animation.animateResizeContainer && e.startWidth !== e.newWidth && e.viewportDeltaX !== e.startWidth - e.newWidth && (i.dom.parent.style.width = e.startWidth + "px"), e.startHeight === e.newHeight && (i.dom.parent.style.height = e.startHeight + "px"), e.startWidth === e.newWidth && (i.dom.parent.style.width = e.startWidth + "px"), e.startHeight === e.newHeight && e.startWidth === e.newWidth && (i.dom.parent.style.overflow = "hidden"), requestAnimationFrame(function() { i.moveTargets(e) })) : i.config.debug.fauxAsync ? setTimeout(function() { i.cleanUp(e) }, i.config.animation.duration) : i.cleanUp(e), i.callFilters("promiseGoMix", o.promise, arguments)
        },
        getStartMixData: function(t) {
            ...
            for (e.incPadding = "border-box" === r, e.callActions("beforeGetStartMixData", arguments), a = 0; s = t.show[a]; a++) n = s.getPosData(), t.showPosData[a] = { startPosData: n };
            for (a = 0; s = t.toHide[a]; a++) n = s.getPosData(), t.toHidePosData[a] = { startPosData: n };
        ...
        moveTargets: function(t) {
            ...
            e.config.animation.animateResizeContainer && (e.dom.parent.style[u.features.transitionProp] = "height " + e.config.animation.duration + "ms ease, width " + e.config.animation.duration + "ms ease ", requestAnimationFrame(function() { t.startHeight !== t.newHeight && t.viewportDeltaY !== t.startHeight - t.newHeight && (e.dom.parent.style.height = t.newHeight + "px"), t.startWidth !== t.newWidth && t.viewportDeltaX !== t.startWidth - t.newWidth && (e.dom.parent.style.width = t.newWidth + "px") })), t.willChangeLayout && (f.removeClass(e.dom.container, e.config.layout.ContainerClassName), f.addClass(e.dom.container, t.newContainerClassName)), e.callActions("afterMoveTargets", arguments)
        },
        hasEffect: function() {
            ...
            for (s = 0; e = t[s]; s++)
                if (0 !== ("undefined" !== (i = this.effectsIn[e]).value ? i.value : i)) { o = !0; break }
            return this.callFilters("resultHasEffect", o, arguments)
        },
        willTransition: function(t, e, i, o) { var s = !1; return s = !!f.isVisible(this.dom.container) && (!!("none" !== t && e || i.x !== o.x || i.y !== o.y) || !!this.config.animation.animateResizeTargets && (i.width !== o.width || i.height !== o.height || i.marginRight !== o.marginRight || i.marginTop !== o.marginTop)), this.callFilters("resultWillTransition", s, arguments) },
        ...
        cleanUp: function(t) {
            var e = this,
                ...
                n = null,
                a = -1;
            for (e.callActions("beforeCleanUp", arguments), e.targetsMoved = e.targetsImmovable = e.targetsBound = e.targetsDone = 0, a = 0; i = t.show[a]; a++) i.cleanUp(), i.show();
            for (a = 0; i = t.toHide[a]; a++) i.cleanUp(), i.hide();
            ...
            t.willSort && (e.targets = t.newOrder), e.state = t.newState, e.lastOperation = t, e.dom.targets = e.state.targets, u.events.fire("mixEnd", e.dom.container, { state: e.state, instance: e }, e.dom.document), "function" == typeof e.config.callbacks.onMixEnd && e.config.callbacks.onMixEnd.call(e.dom.container, e.state, e), t.hasFailed && (u.events.fire("mixFail", e.dom.container, { state: e.state, instance: e }, e.dom.document), "function" == typeof e.config.callbacks.onMixFail && e.config.callbacks.onMixFail.call(e.dom.container, e.state, e), f.addClass(e.dom.container, f.getClassname(e.config.classNames, "container", e.config.classNames.modifierFailed))), "function" == typeof e.userCallback && e.userCallback.call(e.dom.container, e.state, e), "function" == typeof e.userDeferred.resolve && e.userDeferred.resolve(e.state), e.userCallback = null, e.userDeferred = null, e.lastClicked = null, e.isToggling = !1, e.isBusy = !1, e.queue.length && (e.callActions("beforeReadQueueCleanUp", arguments), n = e.queue.shift(), e.userDeferred = n.deferred, e.isToggling = n.isToggling, e.lastClicked = n.triggerElement, n.instruction.command instanceof u.CommandMultimix ? e.multimix.apply(e, n.args) : e.dataset.apply(e, n.args)), e.callActions("afterCleanUp", arguments)
        },
        ...
        parseFilterArgs: function(t) {
            ...
            return e = this.callFilters("instructionParseFilterArgs", e, arguments), f.freeze(e), e
        },
        parseSortArgs: function(t) {
            var e = new u.UserInstruction,
                ...
                o = "",
                s = -1;
            for (e.animate = this.config.animation.enable, e.command = new u.CommandSort, s = 0; s < t.length; s++)
                if (null !== (i = t[s])) switch (typeof i) {
                    case "string":
                        o = i;
                        break;
                    case "object":
            ...
            return o && (e.command = this.parseSortString(o, e.command)), e = this.callFilters("instructionParseSortArgs", e, arguments), f.freeze(e), e
        },
        parseInsertArgs: function(t) {
            ...
            return !e.command.collection.length && this.config.debug.showWarnings && console.warn(u.messages.warningInsertNoElements()), e = this.callFilters("instructionParseInsertArgs", e, arguments), f.freeze(e), e
        },
        parseRemoveArgs: function(t) {
            var e = this,
                ...
                s = null,
                n = -1;
            for (i.animate = e.config.animation.enable, i.command = new u.CommandRemove, n = 0; n < t.length; n++)
                if (null !== (s = t[n])) switch (typeof s) {
                    case "number":
            ...
            if (i.command.collection.length)
                for (n = 0; o = e.targets[n]; n++) - 1 < i.command.collection.indexOf(o.dom.el) && i.command.targets.push(o);
            return !i.command.targets.length && e.config.debug.showWarnings && console.warn(u.messages.warningRemoveNoElements()), f.freeze(i), i
        },
        parseDatasetArgs: function(t) {
            var e = new u.UserInstruction,
                i = null,
                o = -1;
            for (e.animate = this.config.animation.enable, e.command = new u.CommandDataset, o = 0; o < t.length; o++)
        ...
        parseChangeLayoutArgs: function(t) {
            var e = new u.UserInstruction,
                i = null,
                o = -1;
            for (e.animate = this.config.animation.enable, e.command = new u.CommandChangeLayout, o = 0; o < t.length; o++)
                if (null !== (i = t[o])) switch (typeof i) {
                    case "string":
        ...
        queueMix: function(t) {
            var e = this,
                i = null,
                o = "";
            return e.callActions("beforeQueueMix", arguments), i = f.defer(u.libraries), e.config.animation.queue && e.queue.length < e.config.animation.queueLimit ? (t.deferred = i, e.queue.push(t), e.config.controls.enable && (e.isToggling ? (e.buildToggleArray(t.instruction.command), o = e.getToggleSelector(), e.updateControls({ filter: { selector: o } })) : e.updateControls(t.instruction.command))) : (e.config.debug.showWarnings && console.warn(u.messages.warningMultimixInstanceQueueFull()), i.resolve(e.state), u.events.fire("mixBusy", e.dom.container, { state: e.state, instance: e }, e.dom.document), "function" == typeof e.config.callbacks.onMixBusy && e.config.callbacks.onMixBusy.call(e.dom.container, e.state, e)), e.callFilters("promiseQueueMix", i.promise, arguments)
        },
        ...
        diffDatasets: function(t) {
            ...
            for (e.callActions("beforeDiffDatasets", arguments), p = 0; n = t.newDataset[p]; p++) {
                if (void 0 === (h = n[e.config.data.uidKey]) || h.toString().length < 1) throw new TypeError(u.messages.errorDatasetInvalidUidKey({ uidKey: e.config.data.uidKey }));
                if (d[h]) throw new Error(u.messages.errorDatasetDuplicateUid({ uid: h }));
        ...
        insertDatasetFrag: function(t, e, i) { var o = e ? f.arrayFromList(this.dom.parent.children).indexOf(e) : this.targets.length; for (this.dom.parent.insertBefore(t, e); i.length;) this.targets.splice(o, 0, i.shift()), o++ },
        ...
        toggleOn: function() {
            ...
            return e.isToggling = !0, e.toggleArray.indexOf(o) < 0 && e.toggleArray.push(o), t = e.getToggleSelector(), e.multimix({ filter: t }, i.animate, i.callback)
        },
        toggleOff: function() {
            var t, e = this,
                i = e.parseFilterArgs(arguments),
            ...
            return e.isToggling = !0, -1 < s && e.toggleArray.splice(s, 1), t = e.getToggleSelector(), e.multimix({ filter: t }, i.animate, i.callback)
        },
        ...
        dataset: function() {
            var t = this,
                ...
                o = null,
                s = !1;
            return t.callActions("beforeDataset", arguments), t.isBusy ? ((o = new u.QueueItem).args = arguments, o.instruction = e, t.queueMix(o)) : (e.callback && (t.userCallback = e.callback), s = e.animate ^ t.config.animation.enable ? e.animate : t.config.animation.enable, i = t.getDataOperation(e.command.dataset), t.goMix(s, i))
        },
        multimix: function() {
            var t = this,
                e = null,
        ...
        tween: function(t, e) {
            var i = null,
                ...
                s = -1,
                n = -1;
            for (e = Math.min(e, 1), e = Math.max(e, 0), n = 0; i = t.show[n]; n++) o = t.showPosData[n], i.applyTween(o, e);
            for (n = 0; i = t.hide[n]; n++) i.isShown && i.hide(), -1 < (s = t.toHide.indexOf(i)) && (o = t.toHidePosData[s], i.isShown || i.show(), i.applyTween(o, e))
        },
        ...
        getConfig: function(t) { var e = null; return e = t ? f.getProperty(this.config, t) : this.config, this.callFilters("valueGetConfig", e, arguments) },
        configure: function(t) { this.callActions("beforeConfigure", arguments), f.extend(this.config, t, !0, !0), this.callActions("afterConfigure", arguments) },
        getState: function() { var t; return t = new u.State, f.extend(t, this.state), f.freeze(t), this.callFilters("stateGetState", t, arguments) },
        ...
        init: function(t, e, i) {
            ...
            if (o.callActions("beforeInit", arguments), o.mixer = e, t = t || o.render(i), o.cacheDom(t), o.bindEvents(), "none" !== o.dom.el.style.display && (o.isShown = !0), i && e.config.data.uidKey) {
                if (void 0 === (s = i[e.config.data.uidKey]) || s.toString().length < 1) throw new TypeError(u.messages.errorDatasetInvalidUidKey({ uidKey: e.config.data.uidKey }));
        ...
        applyTween: function(t, e) {
            var i = this,
                ...
                r = new u.StyleData,
                l = -1;
            for (i.callActions("beforeApplyTween", arguments), r.x = n.x, r.y = n.y, 0 === e ? i.hide() : i.isShown || i.show(), l = 0; o = u.features.TWEENABLE[l]; l++)
                ...
                if (!s.value) continue;
                r[o].value = n[o].value + s.value * e, r[o].unit = s.unit, a.push(o + "(" + r[o].value + s.unit + ")")
            } else {
                if (!s) continue;
                r[o] = n[o] + s * e, i.dom.el.style[o] = r[o]
            }(r.x || r.y) && a.unshift("translate(" + r.x + "px, " + r.y + "px)"), a.length && (i.dom.el.style[u.features.transformProp] = a.join(" ")), i.callActions("afterApplyTween", arguments)
        },
        ...
        writeTransitionRule: function(t, e, i) { var o, s = this.getDelay(e); return o = t + " " + (0 < i ? i : this.mixer.config.animation.duration) + "ms " + s + "ms " + ("opacity" === t ? "linear" : this.mixer.config.animation.easing), this.callFilters("ruleWriteTransitionRule", o, arguments) },
        getDelay: function(t) { var e, i = this; return "function" == typeof i.mixer.config.animation.staggerSequence && (t = i.mixer.config.animation.staggerSequence.call(i, t, i.state)), e = i.mixer.staggerDuration ? t * i.mixer.staggerDuration : 0, i.callFilters("delayGetDelay", e, arguments) },
        ...
        bindEvents: function() {
            var t, e = this;
            e.callActions("beforeBindEvents", arguments), t = "webkit" === u.features.transitionPrefix ? "webkitTransitionEnd" : "transitionend", e.handler = function(t) { return e.eventBus(t) }, f.on(e.dom.el, t, e.handler), e.callActions("afterBindEvents", arguments)
        },
    ...
    }, u.messages = new u.Messages, u.Facade = function(t) { u.Base.call(this), this.callActions("beforeConstruct", arguments), this.configure = t.configure.bind(t), this.show = t.show.bind(t), this.hide = t.hide.bind(t), this.filter = t.filter.bind(t), this.toggleOn = t.toggleOn.bind(t), this.toggleOff = t.toggleOff.bind(t), this.sort = t.sort.bind(t), this.changeLayout = t.changeLayout.bind(t), this.multimix = t.multimix.bind(t), this.dataset = t.dataset.bind(t), this.tween = t.tween.bind(t), this.insert = t.insert.bind(t), this.insertBefore = t.insertBefore.bind(t), this.insertAfter = t.insertAfter.bind(t), this.prepend = t.prepend.bind(t), this.append = t.append.bind(t), this.remove = t.remove.bind(t), this.destroy = t.destroy.bind(t), this.forceRefresh = t.forceRefresh.bind(t), this.forceRender = t.forceRender.bind(t), this.isMixing = t.isMixing.bind(t), this.getOperation = t.getOperation.bind(t), this.getConfig = t.getConfig.bind(t), this.getState = t.getState.bind(t), this.callActions("afterConstruct", arguments), f.freeze(this), f.seal(this) }, u.BaseStatic.call(u.Facade), u.Facade.prototype = Object.create(u.Base.prototype), u.Facade.prototype.constructor = u.Facade, "object" == typeof exports && "object" == typeof module ? module.exports = u : "function" == typeof define && define.amd ? define(function() { return u }) : void 0 !== p.mixitup && "function" == typeof p.mixitup || (p.mixitup = u), u.BaseStatic.call(u.constructor), u.NAME = "mixitup", u.CORE_VERSION = "3.3.1"
}(window),
function(z) {
    "use strict";
    var q = '<?xml version="1.0" encoding="utf-8"?><svg version="1.1"xmlns="http://www.w3.org/2000/svg"viewBox="0 12.705 512 486.59"x="0px" y="0px"xml:space="preserve"><polygon points="256.814,12.705 317.205,198.566 512.631,198.566 354.529,313.435 414.918,499.295 256.814,384.427 98.713,499.295 159.102,313.435 1,198.566 196.426,198.566 "/></svg>',
        o = { starWidth: "32px", normalFill: "gray", ratedFill: "#f39c12", numStars: 5, maxValue: 5, precision: 1, rating: 0, fullStar: !1, halfStar: !1, readOnly: !1, spacing: "0px", rtl: !1, multiColor: null, onInit: null, onChange: null, onSet: null, starSvg: null },
        W = { startColor: "#c0392b", endColor: "#f1c40f" };

    function U(t, e, i) { return t === e ? t = e : t === i && (t = i), t }

    function X(t) { return void 0 !== t }
    var i = /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i,
        Y = function(t) { if (!i.test(t)) return null; var e = i.exec(t); return { r: parseInt(e[1], 16), g: parseInt(e[2], 16), b: parseInt(e[3], 16) } };

    function V(t, e, i) { var o = i / 100 * (e - t); return 1 === (o = Math.round(t + o).toString(16)).length && (o = "0" + o), o }
    ...
    function G(n, u) {
        ...
        var f, o, m, g, v, t, e = z("<div/>").addClass("jq-ry-group-wrapper").appendTo(n),
            b = z("<div/>").addClass("jq-ry-normal-group").addClass("jq-ry-group").appendTo(e),
        ...
        function l(t) {
            ...
            var e = (a = t) / f,
                i = e * m;
            1 < e && (i += (Math.ceil(e) - 1) * v), x(u.ratedFill), (i = u.rtl ? 100 - i : i) < 0 ? i = 0 : 100 < i && (i = 100), s.css("width", i + "%")
        }

        function c() { t = o * u.numStars + g * (u.numStars - 1), m = o / t * 100, v = g / t * 100, n.width(t), l() }

        function d(t) { var e = u.starWidth = t; return o = window.parseFloat(u.starWidth.replace("px", "")), b.find("svg").attr({ width: u.starWidth, height: e }), s.find("svg").attr({ width: u.starWidth, height: e }), c(), n }

        function h(t) { return u.spacing = t, g = parseFloat(u.spacing.replace("px", "")), b.find("svg:not(:first-child)").css({ "margin-left": t }), s.find("svg:not(:first-child)").css({ "margin-left": t }), c(), n }

        function p(t) { return u.normalFill = t, (u.rtl ? s : b).find("svg").attr({ fill: u.normalFill }), n }
        var w = u.ratedFill;

        function x(t) {
            if (u.multiColor) {
                var e = (a - y) / u.maxValue * 100,
                    i = u.multiColor || {};
                t = function(t, e, i) {
                    if (!t || !e) return null;
                    i = X(i) ? i : 0, t = Y(t), e = Y(e);
                    var o = V(t.r, e.r, i),
                        s = V(t.b, e.b, i);
                    return "#" + o + V(t.g, e.g, i) + s
                }(i.startColor || W.startColor, i.endColor || W.endColor, e)
            } else w = t;
            return u.ratedFill = t, (u.rtl ? b : s).find("svg").attr({ fill: u.ratedFill }), n
        }

        function _(t) { t = !!t, u.rtl = t, p(u.normalFill), l() }

        function C(t) { x((u.multiColor = t) || w) }

        function S(t) { u.numStars = t, f = u.maxValue / u.numStars, b.empty(), s.empty(); for (var e = 0; e < u.numStars; e++) b.append(z(u.starSvg || q)), s.append(z(u.starSvg || q)); return d(u.starWidth), p(u.normalFill), h(u.spacing), l(), n }

        function k(t) { return u.maxValue = t, f = u.maxValue / u.numStars, u.rating > t && O(t), l(), n }

        function T(t) { return u.precision = t, O(u.rating), n }

        function $(t) { return u.halfStar = t, n }

        function A(t) { return u.fullStar = t, n }

        function P(t) {
            var e, i, o, s, n, a = b.offset().left,
                r = a + b.width(),
                l = u.maxValue,
                c = t.pageX,
                d = 0;
        ...
        function I(t) { return u.readOnly = t, n.attr("readonly", !0), H(), t || (n.removeAttr("readonly"), n.on("mousemove", M).on("mouseenter", M).on("mouseleave", R).on("click", N).on("rateyo.init", B).on("rateyo.change", L).on("rateyo.set", j)), n }

        function O(t) {
            var e = t,
                i = u.maxValue;
            return "string" == typeof e && ("%" === e[e.length - 1] && (e = e.substr(0, e.length - 1), k(i = 100)), e = parseFloat(e)),
                function(t, e, i) { if (!(e <= t && t <= i)) throw Error("Invalid Rating, expected value between " + e + " and " + i) }(e, y, i), e = parseFloat(e.toFixed(u.precision)), U(parseFloat(e), y, i), u.rating = e, l(), r && n.trigger("rateyo.set", { rating: e }), n
        }

        function E(t) { return u.onInit = t, n }

        function D(t) { return u.onSet = t, n }

        function F(t) { return u.onChange = t, n }

        function M(t) {
            var e = P(t).toFixed(u.precision),
                i = u.maxValue;
            l(e = U(parseFloat(e), y, i)), n.trigger("rateyo.change", { rating: e })
        }

        function R() {
            var t, e;
            e = !1, t = navigator.userAgent || navigator.vendor || window.opera, (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(t) || /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(t.substr(0, 4))) && (e = !0), e || (l(), n.trigger("rateyo.change", { rating: u.rating }))
        }

        function N(t) {
            var e = P(t).toFixed(u.precision);
            e = parseFloat(e), i.rating(e)
        }

        function B(t, e) { u.onInit && "function" == typeof u.onInit && u.onInit.apply(this, [e.rating, i]) }

        function L(t, e) { u.onChange && "function" == typeof u.onChange && u.onChange.apply(this, [e.rating, i]) }

        function j(t, e) { u.onSet && "function" == typeof u.onSet && u.onSet.apply(this, [e.rating, i]) }

        function H() { n.off("mousemove", M).off("mouseenter", M).off("mouseleave", R).off("click", N).off("rateyo.init", B).off("rateyo.change", L).off("rateyo.set", j) }
        this.rating = function(t) { return X(t) ? (O(t), n) : u.rating }, this.destroy = function() {
            var o, s;
            return u.readOnly || H(), G.prototype.collection = (o = n.get(0), s = this.collection, z.each(s, function(t) {
                if (o === this.node) {
                    var e = s.slice(0, t),
        ...
        }, this.method = function(t) { if (!t) throw Error("Method name not specified!"); if (!X(this[t])) throw Error("Method " + t + " doesn't exist!"); var e = Array.prototype.slice.apply(arguments, []).slice(1); return this[t].apply(this, e) }, this.option = function(t, e) {
            if (!X(t)) return u;
            var i;
            switch (t) {
                case "starWidth":
            ...
            return X(e) ? i(e) : u[t]
        }, S(u.numStars), I(u.readOnly), u.rtl && _(u.rtl), this.collection.push(this), this.rating(u.rating, !0), r = !0, n.trigger("rateyo.init", { rating: u.rating })
    }

    function c(t, e) { var i; return z.each(e, function() { if (t === this.node) return i = this, !1 }), i }
    G.prototype.collection = [], window.RateYo = G, z.fn.rateYo = function() {
        return function(i) {
            var n = G.prototype.collection,
                t = z(this);
            ...
            return i = z.extend({}, o, i), z.each(t, function() {
                ...
                return z.each(e.data(), function(t, e) {
                    if (0 === t.indexOf("rateyo")) {
                        ...
                        i = i[0].toLowerCase() + i.slice(1), o[i] = e, delete s[i]
                    }
                }), new G(z(this), z.extend({}, o, s))
            })
        }.apply(this, Array.prototype.slice.apply(arguments, []))
    }
}(window.jQuery),
function(e) { "undefined" != typeof jQuery && jQuery || "function" != typeof define || !define.amd ? "undefined" != typeof jQuery && jQuery || "object" != typeof exports ? e(jQuery, document, window, navigator) : e(require("jquery"), document, window, navigator) : define(["jquery"], function(t) { return e(t, document, window, navigator) }) }(function(l, c, d, t, h) {
    "use strict";
    var e, i, o = 0,
    ...
    n.prototype = {
            ...
            drawLabels: function() {
                if (this.options) {
                    ...
                    if (!this.options.hide_from_to)
                        if ("single" === this.options.type) t = n ? this.decorate(a[this.result.from]) : (o = this._prettify(this.result.from), this.decorate(o, this.result.from)), this.$cache.single.html(t), this.calcLabels(), this.labels.p_single_left < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible", this.labels.p_single_left + this.labels.p_single_fake > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible";
                        else {
                            i = n ? (this.options.decorate_both ? (t = this.decorate(a[this.result.from]), t += this.options.values_separator, t += this.decorate(a[this.result.to])) : t = this.decorate(a[this.result.from] + this.options.values_separator + a[this.result.to]), e = this.decorate(a[this.result.from]), this.decorate(a[this.result.to])) : (o = this._prettify(this.result.from), s = this._prettify(this.result.to), this.options.decorate_both ? (t = this.decorate(o, this.result.from), t += this.options.values_separator, t += this.decorate(s, this.result.to)) : t = this.decorate(o + this.options.values_separator + s, this.result.to), e = this.decorate(o, this.result.from), this.decorate(s, this.result.to)), this.$cache.single.html(t), this.$cache.from.html(e), this.$cache.to.html(i), this.calcLabels();
            ...
            calcGridCollision: function(t, e, i) { var o, s, n, a = this.coords.big_num; for (o = 0; o < a && !(a <= (s = o + t / 2)); o += t) n = this.$cache.grid_labels[s][0], i[o] <= e[s] ? n.style.visibility = "visible" : n.style.visibility = "hidden" },
    ...
    if (l.console = l.console || { info: function(t) {} }, m)
        if (m.fn.fancybox) console.info("fancyBox already initialized");
            ...
            var t, e, i, o, s = { closeExisting: !1, loop: !1, gutter: 50, keyboard: !0, preventCaptionOverlap: !0, arrows: !0, infobar: !0, smallBtn: "auto", toolbar: "auto", buttons: ["zoom", "slideShow", "thumbs", "close"], idleTime: 3, protect: !1, modal: !1, image: { preload: !1 }, ajax: { settings: { data: { fancybox: !0 } } }, iframe: { tpl: '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" allowfullscreen="allowfullscreen" allow="autoplay; fullscreen" src=""></iframe>', preload: !0, css: {}, attr: { scrolling: "auto" } }, video: { tpl: '<video class="fancybox-video" controls controlsList="nodownload" poster="{{poster}}"><source src="{{src}}" type="{{format}}" />Sorry, your browser doesn\'t support embedded videos, <a href="{{src}}">download</a> and watch with your favorite video player!</video>', format: "", autoStart: !0 }, defaultType: "image", animationEffect: "zoom", animationDuration: 366, zoomOpacity: "auto", transitionEffect: "fade", transitionDuration: 366, slideClass: "", baseClass: "", baseTpl: '<div class="fancybox-container" role="dialog" tabindex="-1"><div class="fancybox-bg"></div><div class="fancybox-inner"><div class="fancybox-infobar"><span data-fancybox-index></span>&nbsp;/&nbsp;<span data-fancybox-count></span></div><div class="fancybox-toolbar">{{buttons}}</div><div class="fancybox-navigation">{{arrows}}</div><div class="fancybox-stage"></div><div class="fancybox-caption"><div class="fancybox-caption__body"></div></div></div></div>', spinnerTpl: '<div class="fancybox-loading"></div>', errorTpl: '<div class="fancybox-error"><p>{{ERROR}}</p></div>', btnTpl: { download: '<a download data-fancybox-download class="fancybox-button fancybox-button--download" title="{{DOWNLOAD}}" href="javascript:;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.62 17.09V19H5.38v-1.91zm-2.97-6.96L17 11.45l-5 4.87-5-4.87 1.36-1.32 2.68 2.64V5h1.92v7.77z"/></svg></a>', zoom: '<button data-fancybox-zoom class="fancybox-button fancybox-button--zoom" title="{{ZOOM}}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.7 17.3l-3-3a5.9 5.9 0 0 0-.6-7.6 5.9 5.9 0 0 0-8.4 0 5.9 5.9 0 0 0 0 8.4 5.9 5.9 0 0 0 7.7.7l3 3a1 1 0 0 0 1.3 0c.4-.5.4-1 0-1.5zM8.1 13.8a4 4 0 0 1 0-5.7 4 4 0 0 1 5.7 0 4 4 0 0 1 0 5.7 4 4 0 0 1-5.7 0z"/></svg></button>', close: '<button data-fancybox-close class="fancybox-button fancybox-button--close" title="{{CLOSE}}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 10.6L6.6 5.2 5.2 6.6l5.4 5.4-5.4 5.4 1.4 1.4 5.4-5.4 5.4 5.4 1.4-1.4-5.4-5.4 5.4-5.4-1.4-1.4-5.4 5.4z"/></svg></button>', arrowLeft: '<button data-fancybox-prev class="fancybox-button fancybox-button--arrow_left" title="{{PREV}}"><div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M11.28 15.7l-1.34 1.37L5 12l4.94-5.07 1.34 1.38-2.68 2.72H19v1.94H8.6z"/></svg></div></button>', arrowRight: '<button data-fancybox-next class="fancybox-button fancybox-button--arrow_right" title="{{NEXT}}"><div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M15.4 12.97l-2.68 2.72 1.34 1.38L19 12l-4.94-5.07-1.34 1.38 2.68 2.72H5v1.94z"/></svg></div></button>', smallBtn: '<button type="button" data-fancybox-close class="fancybox-button fancybox-close-small" title="{{CLOSE}}"><svg xmlns="http://www.w3.org/2000/svg" version="1" viewBox="0 0 24 24"><path d="M13 12l5-5-1-1-5 5-5-5-1 1 5 5-5 5 1 1 5-5 5 5 1-1z"/></svg></button>' }, parentEl: "body", hideScrollbar: !0, autoFocus: !0, backFocus: !0, trapFocus: !0, fullScreen: { autoStart: !1 }, touch: { vertical: !0, momentum: !0 }, hash: null, media: {}, slideShow: { autoStart: !1, speed: 3e3 }, thumbs: { autoStart: !1, hideOnClose: !0, parentEl: ".fancybox-container", axis: "y" }, wheel: "auto", onInit: m.noop, beforeLoad: m.noop, afterLoad: m.noop, beforeShow: m.noop, afterShow: m.noop, beforeClose: m.noop, afterClose: m.noop, onActivate: m.noop, onDeactivate: m.noop, clickContent: function(t, e) { return "image" === t.type && "zoom" }, clickSlide: "close", clickOutside: "close", dblclickContent: !1, dblclickSlide: !1, dblclickOutside: !1, mobile: { preventCaptionOverlap: !1, idleTime: !1, clickContent: function(t, e) { return "image" === t.type && "toggleControls" }, clickSlide: function(t, e) { return "image" === t.type ? "toggleControls" : "close" }, dblclickContent: function(t, e) { return "image" === t.type && "zoom" }, dblclickSlide: function(t, e) { return "image" === t.type && "zoom" } }, lang: "en", i18n: { en: { CLOSE: "Close", NEXT: "Next", PREV: "Previous", ERROR: "The requested content cannot be loaded. <br/> Please try again later.", PLAY_START: "Start slideshow", PLAY_STOP: "Pause slideshow", FULL_SCREEN: "Full screen", THUMBS: "Thumbnails", DOWNLOAD: "Download", SHARE: "Share", ZOOM: "Zoom" }, de: { CLOSE: "Schlie&szlig;en", NEXT: "Weiter", PREV: "Zur&uuml;ck", ERROR: "Die angeforderten Daten konnten nicht geladen werden. <br/> Bitte versuchen Sie es sp&auml;ter nochmal.", PLAY_START: "Diaschau starten", PLAY_STOP: "Diaschau beenden", FULL_SCREEN: "Vollbild", THUMBS: "Vorschaubilder", DOWNLOAD: "Herunterladen", SHARE: "Teilen", ZOOM: "Vergr&ouml;&szlig;ern" } } },
                ...
                a = m(h),
                r = 0,
                p = l.requestAnimationFrame || l.webkitRequestAnimationFrame || l.mozRequestAnimationFrame || l.oRequestAnimationFrame || function(t) { return l.setTimeout(t, 1e3 / 60) },
                c = l.cancelAnimationFrame || l.webkitCancelAnimationFrame || l.mozCancelAnimationFrame || l.oCancelAnimationFrame || function(t) { l.clearTimeout(t) },
                d = function() {
            ...
            m.extend(v.prototype, {
                ...
                addEvents: function() {
                    var o = this;
                    o.removeEvents(), o.$refs.container.on("click.fb-close", "[data-fancybox-close]", function(t) { t.stopPropagation(), t.preventDefault(), o.close(t) }).on("touchstart.fb-prev click.fb-prev", "[data-fancybox-prev]", function(t) { t.stopPropagation(), t.preventDefault(), o.previous() }).on("touchstart.fb-next click.fb-next", "[data-fancybox-next]", function(t) { t.stopPropagation(), t.preventDefault(), o.next() }).on("click.fb", "[data-fancybox-zoom]", function(t) { o[o.isScaledDown() ? "scaleToActual" : "scaleToFit"]() }), n.on("orientationchange.fb resize.fb", function(t) { t && t.originalEvent && "resize" === t.originalEvent.type ? (o.requestId && c(o.requestId), o.requestId = p(function() { o.update(t) })) : (o.current && "iframe" === o.current.type && o.$refs.stage.hide(), setTimeout(function() { o.$refs.stage.show(), o.update(t) }, m.fancybox.isMobile ? 600 : 250)) }), a.on("keydown.fb", function(t) {
                ...
                removeEvents: function() { n.off("orientationchange.fb resize.fb"), a.off("keydown.fb .fb-idle"), this.$refs.container.off(".fb-close .fb-prev .fb-next"), this.idleInterval && (l.clearInterval(this.idleInterval), this.idleInterval = null) },
                ...
                jumpTo: function(t, o) {
                    ...
                    if (!(h.isDragging || h.isClosing || h.isAnimating && h.firstRun)) {
                        ...
                        r = m.fancybox.getTranslate(a.$slide), l = m.fancybox.getTranslate(h.$refs.stage), m.each(h.slides, function(t, e) { m.fancybox.stop(e.$slide, !0) }), a.pos !== n.pos && (a.isComplete = !1), a.$slide.removeClass("fancybox-slide--complete fancybox-slide--current"), i ? (d = r.left - (a.pos * r.width + a.pos * a.opts.gutter), m.each(h.slides, function(t, e) {
                        ...
                        })) : o && n.opts.transitionEffect && (c = "fancybox-animated fancybox-fx-" + n.opts.transitionEffect, a.$slide.addClass("fancybox-slide--" + (a.pos > n.pos ? "next" : "previous")), m.fancybox.animate(a.$slide, c, o, function() { a.$slide.removeClass(c).removeClass("fancybox-slide--next fancybox-slide--previous") }, !1)), n.isLoaded ? h.revealContent(n) : h.loadSlide(n), h.preload("image")
                    }
                },
                ...
                setImage: function(e) {
                    ...
                    }, 50), i.checkSrcset(e), e.$content = m('<div class="fancybox-content"></div>').addClass("fancybox-is-hidden").appendTo(e.$slide.addClass("fancybox-slide--image")), !1 !== e.opts.preload && e.opts.width && e.opts.height && e.thumb && (e.width = e.opts.width, e.height = e.opts.height, (t = h.createElement("img")).onerror = function() { m(this).remove(), e.$ghost = null }, t.onload = function() { i.afterLoad(e) }, e.$ghost = m(t).addClass("fancybox-image").appendTo(e.$content).attr("src", e.thumb)), i.setBigImage(e)
                },
                checkSrcset: function(t) {
                    ...
                    if (n) {
                        ...
                        for (var a = 0; a < i.length; a++) { var r = i[a]; if ("w" === r.postfix && r.value >= s || "x" === r.postfix && r.value >= o) { e = r; break } }!e && i.length && (e = i[i.length - 1]), e && (t.src = e.url, t.width && t.height && "w" == e.postfix && (t.height = t.width / t.height * e.value, t.width = e.value), t.opts.srcset = n)
                    }
                },
                ...
                setIframe: function(s) {
                    var n, e = this,
                        a = s.opts.iframe,
                        r = s.$slide;
                    s.$content = m('<div class="fancybox-content' + (a.preload ? " fancybox-is-hidden" : "") + '"></div>').css(a.css).appendTo(r), r.addClass("fancybox-slide--" + s.contentType), s.$iframe = n = m(a.tpl.replace(/\{rnd\}/g, (new Date).getTime())).attr(a.attr).appendTo(s.$content), a.preload ? (e.showLoading(s), n.on("load.fb error.fb", function(t) { this.isReady = 1, s.$slide.trigger("refresh"), e.afterLoad(s) }), r.on("refresh.fb", function() {
                        var t, e = s.$content,
                            i = a.css.width,
                            o = a.css.height;
                        if (1 === n[0].isReady) {
                    ...
                    })) : e.afterLoad(s), n.attr("src", s.src), r.one("onReset", function() {
                ...
                adjustCaption: function(t) {
                    var e, i = this,
                        ...
                        a = i.$refs.caption,
                        r = !1;
                    a.toggleClass("fancybox-caption--separate", n), n && s && s.length && (o.pos !== i.currPos ? ((e = a.clone().appendTo(a.parent())).children().eq(0).empty().html(s), r = e.outerHeight(!0), e.empty().remove()) : i.$caption && (r = i.$caption.outerHeight(!0)), o.$slide.css("padding-bottom", r || ""))
                },
                ...
                revealContent: function(t) {
                    var e, i, o, s, n = this,
                        ...
                        c = n.isMoved(t),
                        d = t.isRevealed;
                    return t.isRevealed = !0, e = t.opts[n.firstRun ? "animationEffect" : "transitionEffect"], o = t.opts[n.firstRun ? "animationDuration" : "transitionDuration"], o = parseInt(t.forcedDuration === g ? o : t.forcedDuration, 10), !c && t.pos === n.currPos && o || (e = !1), "zoom" === e && (t.pos === n.currPos && o && "image" === t.type && !t.hasError && (l = n.getThumbPos(t)) ? r = n.getFitPos(t) : e = "fade"), "zoom" === e ? (n.isAnimating = !0, r.scaleX = r.width / l.width, r.scaleY = r.height / l.height, "auto" == (s = t.opts.zoomOpacity) && (s = .1 < Math.abs(t.width / t.height - l.width / l.height)), s && (l.opacity = .1, r.opacity = 1), m.fancybox.setTranslate(t.$content.removeClass("fancybox-is-hidden"), l), u(t.$content), void m.fancybox.animate(t.$content, r, o, function() { n.isAnimating = !1, n.complete() })) : (n.updateSlide(t), e ? (m.fancybox.stop(a), i = "fancybox-slide--" + (t.pos >= n.prevPos ? "next" : "previous") + " fancybox-animated fancybox-fx-" + e, a.addClass(i).removeClass("fancybox-slide--current"), t.$content.removeClass("fancybox-is-hidden"), u(a), "image" !== t.type && t.$content.hide().show(0), void m.fancybox.animate(a, "fancybox-slide--current", o, function() { a.removeClass(i).css({ transform: "", opacity: "" }), t.pos === n.currPos && n.complete() }, !0)) : (t.$content.removeClass("fancybox-is-hidden"), d || !c || "image" !== t.type || t.hasError || t.$content.hide().fadeIn("fast"), void(t.pos === n.currPos && n.complete())))
                },
                getThumbPos: function(t) { var e, i, o, s, n, a, r, l, c, d = t.$thumb; return !!(d && (r = d[0]) && r.ownerDocument === h && (m(".fancybox-container").css("pointer-events", "none"), l = { x: r.getBoundingClientRect().left + r.offsetWidth / 2, y: r.getBoundingClientRect().top + r.offsetHeight / 2 }, c = h.elementFromPoint(l.x, l.y) === r, m(".fancybox-container").css("pointer-events", ""), c)) && (i = m.fancybox.getTranslate(d), o = parseFloat(d.css("border-top-width") || 0), s = parseFloat(d.css("border-right-width") || 0), n = parseFloat(d.css("border-bottom-width") || 0), a = parseFloat(d.css("border-left-width") || 0), e = { top: i.top + o, left: i.left + a, width: i.width - s - a, height: i.height - o - n, scaleX: 1, scaleY: 1 }, 0 < i.width && 0 < i.height && e) },
                complete: function() {
                    var t, i = this,
                        e = i.current,
                        o = {};
                ...
                focus: function(t, e) {
                    ...
                    s.isClosing || ((i = (i = !t && s.current && s.current.isComplete ? s.current.$slide.find("*:visible" + (e ? ":not(.fancybox-close-small)" : "")) : s.$refs.container.find("*:visible")).filter(n).filter(function() { return "hidden" !== m(this).css("visibility") && !m(this).hasClass("disabled") })).length ? (o = i.index(h.activeElement), t && t.shiftKey ? (o < 0 || 0 == o) && (t.preventDefault(), i.eq(i.length - 1).trigger("focus")) : (o < 0 || o == i.length - 1) && (t && t.preventDefault(), i.eq(0).trigger("focus"))) : s.$refs.container.trigger("focus"))
                },
                activate: function() {
                    var e = this;
                ...
                updateControls: function() {
                    var t = this,
                        ...
                        s = t.$refs.caption,
                        n = e.opts.caption;
                    e.$slide.trigger("refresh"), n && n.length ? (t.$caption = s).children().eq(0).html(n) : t.$caption = null, t.hasHiddenControls || t.isIdle || t.showControls(), o.find("[data-fancybox-count]").html(t.group.length), o.find("[data-fancybox-index]").html(i + 1), o.find("[data-fancybox-prev]").prop("disabled", !e.opts.loop && i <= 0), o.find("[data-fancybox-next]").prop("disabled", !e.opts.loop && i >= t.group.length - 1), "image" === e.type ? o.find("[data-fancybox-zoom]").show().end().find("[data-fancybox-download]").attr("href", e.opts.image.src || e.src).show() : e.opts.toolbar && o.find("[data-fancybox-download],[data-fancybox-zoom]").hide(), m(h.activeElement).is(":hidden,[disabled]") && t.$refs.container.trigger("focus")
                },
...
function(u) {
    ...
    function f(i, t, e) { if (i) return e = e || "", "object" === u.type(e) && (e = u.param(e, !0)), u.each(t, function(t, e) { i = i.replace("$" + t, e || "") }), e.length && (i += (0 < i.indexOf("?") ? "&" : "?") + e), i }
    ...
    u(document).on("objectNeedsType.fb", function(t, e, s) {
        ...
        i = u.extend(!0, {}, o, s.opts.media), u.each(i, function(t, e) {
            if (a = h.match(e.matcher)) {
                ...
                return r = u.extend(!0, {}, e.params, s.opts[t], c), h = "function" === u.type(e.url) ? e.url.call(this, a, r, s) : f(e.url, a, r), n = "function" === u.type(e.thumb) ? e.thumb.call(this, a, r, s) : f(e.thumb, a), "youtube" === t ? h = h.replace(/&t=((\d+)m)?(\d+)s/, function(t, e, i, o) { return "&start=" + ((i ? 60 * parseInt(i, 10) : 0) + parseInt(o, 10)) }) : "vimeo" === t && (h = h.replace("&%23", "#")), !1
            }
        }), p ? (s.opts.thumb || s.opts.$thumb && s.opts.$thumb.length || (s.opts.thumb = n), "iframe" === p && (s.opts = u.extend(!0, s.opts, { iframe: { preload: !1, attr: { scrolling: "no" } } })), u.extend(s, { type: p, src: h, origSrc: s.src, contentSource: d, contentType: "image" === p ? "image" : "gmap_place" == d || "gmap_search" == d ? "map" : "video" })) : h && (s.type = s.opts.defaultType)
    });
    var s = {
        ...
        done: function(t) { var e, i; "youtube" === t && delete window.onYouTubeIframeAPIReady, (e = u.fancybox.getInstance()) && (i = e.current.$content.find("iframe"), "youtube" === t && void 0 !== YT && YT ? new YT.Player(i.attr("id"), { events: { onStateChange: function(t) { 0 == t.data && e.next() } } }) : "vimeo" === t && void 0 !== Vimeo && Vimeo && new Vimeo.Player(i).on("ended", function() { e.next() })) }
    };
    u(document).on({ "afterShow.fb": function(t, e, i) { 1 < e.group.length && ("youtube" === i.contentSource || "vimeo" === i.contentSource) && s.load(i.contentSource) } })
}(jQuery),
function(m, l, g) {
    "use strict";
    ...
    function h(t) { for (var e, i, o, s, n, a = !1; e = t.get(0), 0, i = m.getComputedStyle(e)["overflow-y"], o = m.getComputedStyle(e)["overflow-x"], s = ("scroll" === i || "auto" === i) && e.scrollHeight > e.clientHeight, n = ("scroll" === o || "auto" === o) && e.scrollWidth > e.clientWidth, !(a = s || n) && (t = t.parent()).length && !t.hasClass("fancybox-stage") && !t.is("body");); return a }
    ...
    var b = m.requestAnimationFrame || m.webkitRequestAnimationFrame || m.mozRequestAnimationFrame || m.oRequestAnimationFrame || function(t) { return m.setTimeout(t, 1e3 / 60) },
        y = m.cancelAnimationFrame || m.webkitCancelAnimationFrame || m.mozCancelAnimationFrame || m.oCancelAnimationFrame || function(t) { m.clearTimeout(t) };
    i.prototype.destroy = function() {
        ...
        var t = this;
        v(t.newPoints[0], t.realPoints[0]) < (g.fancybox.isMobile ? 10 : 5) ? t.startPoints = t.newPoints : (t.canTap = !1, t.contentLastPos = t.limitMovement(), t.requestId && y(t.requestId), t.requestId = b(function() { g.fancybox.setTranslate(t.$content, t.contentLastPos) }))
        ...
        var t, e, i, o, s, n, a = this,
            ...
            f = h.width,
            m = h.height;
        return s = r < f ? p + c : p, n = u + d, t = Math.max(0, .5 * r - .5 * f), e = Math.max(0, .5 * l - .5 * m), i = Math.min(r - f, .5 * r - .5 * f), o = Math.min(l - m, .5 * l - .5 * m), 0 < c && t < s && (s = t - 1 + Math.pow(-t + p + c, .8) || 0), c < 0 && s < i && (s = i + 1 - Math.pow(i - p - c, .8) || 0), 0 < d && e < n && (n = e - 1 + Math.pow(-e + u + d, .8) || 0), d < 0 && n < o && (n = o + 1 - Math.pow(o - u - d, .8) || 0), { top: n, left: s }
        ...
        var t = this,
            ...
            f = { top: n + (d + (p - t.centerPointStartY)), left: s + (c + u), scaleX: a, scaleY: a };
        t.canTap = !1, t.newWidth = r, t.newHeight = l, t.contentLastPos = f, t.requestId && y(t.requestId), t.requestId = b(function() { g.fancybox.setTranslate(t.$content, t.contentLastPos) })
        ...
        i.sliderLastPos = null, "y" == t && !e && 50 < Math.abs(i.distanceY) ? (g.fancybox.animate(i.instance.current.$slide, { top: i.sliderStartPos.top + i.distanceY + 150 * i.velocityY, opacity: 0 }, 200), o = i.instance.close(!0, 250)) : a && 0 < i.distanceX ? o = i.instance.previous(300) : a && i.distanceX < 0 && (o = i.instance.next(300)), !1 !== o || "x" != t && "y" != t || i.instance.centerSlide(200), i.$container.removeClass("fancybox-is-sliding")
        ...
        var t, e, i, o, s = this,
            ...
            a = s.newWidth,
            r = s.newHeight;
        s.contentLastPos && (t = s.contentLastPos.left, o = { top: e = s.contentLastPos.top, left: t, width: a, height: r, scaleX: 1, scaleY: 1 }, g.fancybox.setTranslate(s.$content, o), a < s.canvasWidth && r < s.canvasHeight ? s.instance.scaleToFit(150) : a > n.width || r > n.height ? s.instance.scaleToActual(s.centerPointStartX, s.centerPointStartY, 150) : (i = s.limitPosition(t, e, a, r), g.fancybox.animate(s.$content, i, 150)))
        ...
        if ((!i.originalEvent || 2 != i.originalEvent.button) && (s.is("img") || !(l > s[0].clientWidth + s.offset().left))) {
            ...
            if (o.tapped) {
                ...
                t("dblclick" + e)
            } else o.tapX = l, o.tapY = c, a.opts["dblclick" + e] && a.opts["dblclick" + e] !== a.opts["click" + e] ? o.tapped = setTimeout(function() { o.tapped = null, n.isAnimating || t("click" + e) }, 500) : t("click" + e);
            return this
        }
...
function(a, r) {
    ...
    r.extend(i.prototype, {
        ...
        init: function() {
            ...
            t.$button = e.$refs.toolbar.find("[data-fancybox-play]").on("click", function() { t.toggle() }), e.group.length < 2 || !i ? t.$button.hide() : i.progress && (t.$progress = r('<div class="fancybox-progress"></div>').appendTo(e.$refs.inner))
        },
        set: function(t) {
            var e = this,
                i = e.instance,
        ...
        "afterKeydown.fb": function(t, e, i, o, s) { var n = e && e.SlideShow;!n || !i.opts.slideShow || 80 !== s && 32 !== s || r(a.activeElement).is("button,a,input") || (o.preventDefault(), n.toggle()) },
    ...
    n.extend(o.prototype, {
        ...
        create: function() {
            var i, t = this,
                ...
                o = t.opts.parentEl,
                s = [];
            t.$grid || (t.$grid = n('<div class="' + a + " " + a + "-" + t.opts.axis + '"></div>').appendTo(e.$refs.container.find(o).addBack().filter(o)), t.$grid.on("click", "a", function() { e.jumpTo(n(this).attr("data-index")) })), t.$list || (t.$list = n('<div class="' + a + '__list">').appendTo(t.$grid)), n.each(e.group, function(t, e) {
        ...
        focus: function(t) {
            var e, i, o = this,
                s = o.$list,
                n = o.$grid;
            o.instance.current && (i = (e = s.children().removeClass(r).filter('[data-index="' + o.instance.current.index + '"]').addClass(r)).position(), "y" === o.opts.axis && (i.top < 0 || i.top > s.height() - e.outerHeight()) ? s.stop().animate({ scrollTop: s.scrollTop() + i.top }, t) : "x" === o.opts.axis && (i.left < n.scrollLeft() || i.left > n.scrollLeft() + (n.width() - e.outerWidth())) && s.parent().stop().animate({ scrollLeft: i.left }, t))
        },
        update: function() {
            var t = this;
...
function(n, a, s) {
    ...
    s.escapeSelector || (s.escapeSelector = function(t) { return (t + "").replace(/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g, function(t, e) { return e ? "\0" === t ? "�" : t.slice(0, -1) + "\\" + t.charCodeAt(t.length - 1).toString(16) + " " : "\\" + t }) }), s(function() {
        !1 !== s.fancybox.defaults.hash && (s(a).on({
            "onInit.fb": function(t, e) { var i, o;!1 !== e.group[e.currIndex].opts.hash && (i = r(), (o = l(e)) && i.gallery && o == i.gallery && (e.currIndex = i.index - 1)) },
            "beforeShow.fb": function(t, e, i, o) {
                var s;
            ...
            "beforeClose.fb": function(t, e, i) { i && !1 !== i.opts.hash && (clearTimeout(e.hashTimer), e.currentHash && e.hasCreatedHistory ? n.history.back() : e.currentHash && ("replaceState" in n.history ? n.history.replaceState({}, a.title, n.location.pathname + n.location.search + (e.origHash || "")) : n.location.hash = e.origHash), e.currentHash = null) }
        ...
        }), setTimeout(function() { s.fancybox.getInstance() || e(r()) }, 50))
    })
}(window, document, jQuery),
function(t, e) {
    "use strict";
...
function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : "object" == typeof exports ? module.exports = t($ || require("jquery")) : t(jQuery) }(function(R) {
    "use strict";
    var s = "styler",
        o = { idSuffix: "-styler", filePlaceholder: "Файл не выбран", fileBrowse: "Обзор...", fileNumber: "Выбрано файлов: %s", selectPlaceholder: "Выберите...", selectSearch: !1, selectSearchLimit: 10, selectSearchNotFound: "Совпадений не найдено", selectSearchPlaceholder: "Поиск...", selectVisibleOptions: 0, selectSmartPositioning: !0, locale: "ru", locales: { en: { filePlaceholder: "No file selected", fileBrowse: "Browse...", fileNumber: "Selected files: %s", selectPlaceholder: "Select...", selectSearchNotFound: "No matches found", selectSearchPlaceholder: "Search..." } }, onSelectOpened: function() {}, onSelectClosed: function() {}, onFormStyled: function() {} };

    function n(t, e) {
        this.element = t, this.options = R.extend({}, o, e);
        var i = this.options.locale;
        void 0 !== this.options.locales[i] && R.extend(this.options, this.options.locales[i]), this.init()
    }

    function N(t) {
        if (!R(t.target).parents().hasClass("jq-selectbox") && "OPTION" != t.target.nodeName && R("div.jq-selectbox.opened").length) {
            var e = R("div.jq-selectbox.opened"),
                i = R("div.jq-selectbox__search input", e),
                o = R("div.jq-selectbox__dropdown", e);
            e.find("select").data("_" + s).options.onSelectClosed.call(e), i.length && i.val("").keyup(), o.hide().find("li.sel").addClass("selected"), e.removeClass("focused opened dropup dropdown")
        }
    }
    n.prototype = {
        init: function() {
            var E = R(this.element),
                D = this.options,
                F = !(!navigator.userAgent.match(/(iPad|iPhone|iPod)/i) || navigator.userAgent.match(/(Windows\sPhone)/i)),
                t = !(!navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/(Windows\sPhone)/i));

            function M() { void 0 !== E.attr("id") && "" !== E.attr("id") && (this.id = E.attr("id") + D.idSuffix), this.title = E.attr("title"), this.classes = E.attr("class"), this.data = E.data() }
            if (E.is(":checkbox")) {
                var e = function() {
                    var t = new M,
                        e = R('<div class="jq-checkbox"><div class="jq-checkbox__div"></div></div>').attr({ id: t.id, title: t.title }).addClass(t.classes).data(t.data);
                ...
                e(), E.on("refresh", function() { E.closest("label").add('label[for="' + E.attr("id") + '"]').off(".styler"), E.off(".styler").parent().before(E).remove(), e() })
            } else if (E.is(":radio")) {
                var i = function() {
                    var t = new M,
                        i = R('<div class="jq-radio"><div class="jq-radio__div"></div></div>').attr({ id: t.id, title: t.title }).addClass(t.classes).data(t.data);
                    E.after(i).prependTo(i), E.is(":checked") && i.addClass("checked"), E.is(":disabled") && i.addClass("disabled"), R.fn.commonParents = function() { var t = this; return t.first().parents().filter(function() { return R(this).find(t).length === t.length }) }, R.fn.commonParent = function() { return R(this).commonParents().first() }, i.click(function(t) {
                        if (t.preventDefault(), E.triggerHandler("click"), !i.is(".disabled")) {
                            var e = R('input[name="' + E.attr("name") + '"]');
                            e.commonParent().find(e).prop("checked", !1).parent().removeClass("checked"), E.prop("checked", !0).parent().addClass("checked"), E.focus().change()
                        }
                    }), E.closest("label").add('label[for="' + E.attr("id") + '"]').on("click.styler", function(t) { R(t.target).is("a") || R(t.target).closest(i).length || (i.triggerHandler("click"), t.preventDefault()) }), E.on("change.styler", function() { E.parent().addClass("checked") }).on("focus.styler", function() { i.is(".disabled") || i.addClass("focused") }).on("blur.styler", function() { i.removeClass("focused") })
                };
                i(), E.on("refresh", function() { E.closest("label").add('label[for="' + E.attr("id") + '"]').off(".styler"), E.off(".styler").parent().before(E).remove(), i() })
            } else if (E.is(":file")) {
                var o = function() {
                    var t = new M,
                    ...
                    var s = R('<div class="jq-file"><div class="jq-file__name">' + o + '</div><div class="jq-file__browse">' + e + "</div></div>").attr({ id: t.id, title: t.title }).addClass(t.classes).data(t.data);
                    E.after(s).appendTo(s), E.is(":disabled") && s.addClass("disabled");
                    var i = E.val(),
                        n = R("div.jq-file__name", s);
                    i && n.text(i.replace(/.+[\\\/]/, "")), E.on("change.styler", function() {
                        var t = E.val();
                        if (E.is("[multiple]")) {
                            t = "";
                            ...
                            if (0 < e) {
                                var i = E.data("number");
                                void 0 === i && (i = D.fileNumber), t = i = i.replace("%s", e)
                            }
                        }
                        n.text(t.replace(/.+[\\\/]/, "")), "" === t ? (n.text(o), s.removeClass("changed")) : s.addClass("changed")
                    }).on("focus.styler", function() { s.addClass("focused") }).on("blur.styler", function() { s.removeClass("focused") }).on("click.styler", function() { s.removeClass("focused") })
                };
                o(), E.on("refresh", function() { E.off(".styler").parent().before(E).remove(), o() })
            } else if (E.is('input[type="number"]')) {
                var s = function() {
                    var t = new M,
                        e = R('<div class="jq-number"><div class="jq-number__spin minus"></div><div class="jq-number__spin plus"></div></div>').attr({ id: t.id, title: t.title }).addClass(t.classes).data(t.data);
                    E.after(e).prependTo(e).wrap('<div class="jq-number__field"></div>'), E.is(":disabled") && e.addClass("disabled");
                    var n, a, r, i = null,
                        o = null;
                    void 0 !== E.attr("min") && (n = E.attr("min")), void 0 !== E.attr("max") && (a = E.attr("max")), r = void 0 !== E.attr("step") && R.isNumeric(E.attr("step")) ? Number(E.attr("step")) : Number(1);

                    function s(t) {
                        var e, i = E.val();
                        R.isNumeric(i) || (i = 0, E.val("0")), t.is(".minus") ? e = Number(i) - r : t.is(".plus") && (e = Number(i) + r);
                        var o = (r.toString().split(".")[1] || []).length;
                        if (0 < o) {
                            for (var s = "1"; s.length <= o;) s += "0";
                            e = Math.round(e * s) / s
                        }
                        R.isNumeric(n) && R.isNumeric(a) ? n <= e && e <= a && E.val(e) : R.isNumeric(n) && !R.isNumeric(a) ? n <= e && E.val(e) : (R.isNumeric(n) || !R.isNumeric(a) || e <= a) && E.val(e)
                    }
                    e.is(".disabled") || (e.on("mousedown", "div.jq-number__spin", function() {
                        var t = R(this);
                        s(t), i = setTimeout(function() { o = setInterval(function() { s(t) }, 40) }, 350)
                    }).on("mouseup mouseout", "div.jq-number__spin", function() { clearTimeout(i), clearInterval(o) }).on("mouseup", "div.jq-number__spin", function() { E.change().trigger("input") }), E.on("focus.styler", function() { e.addClass("focused") }).on("blur.styler", function() { e.removeClass("focused") }))
                };
                s(), E.on("refresh", function() { E.off(".styler").closest(".jq-number").before(E).remove(), s() })
            } else if (E.is("select")) {
                var n = function() {
                    function A(e) {
                        var i = e.prop("scrollHeight") - e.outerHeight(),
                            o = null,
                            s = null;
                        e.off("mousewheel DOMMouseScroll").on("mousewheel DOMMouseScroll", function(t) { o = t.originalEvent.detail < 0 || 0 < t.originalEvent.wheelDelta ? 1 : -1, s = e.scrollTop(), (i <= s && o < 0 || s <= 0 && 0 < o) && (t.stopPropagation(), t.preventDefault()) })
                    }
                    var P = R("option", E),
                        I = "";
                    ...
                    function O() {
                        for (var t = 0; t < P.length; t++) {
                            var e = P.eq(t),
                                ...
                                c = "",
                                d = "";
                            e.prop("selected") && (o = "selected sel"), e.is(":disabled") && (o = "disabled"), e.is(":selected:disabled") && (o = "selected sel disabled"), void 0 !== e.attr("id") && "" !== e.attr("id") && (n = ' id="' + e.attr("id") + D.idSuffix + '"'), void 0 !== e.attr("title") && "" !== P.attr("title") && (a = ' title="' + e.attr("title") + '"'), void 0 !== e.attr("class") && (l = " " + e.attr("class"), d = ' data-jqfs-class="' + e.attr("class") + '"');
                            var h = e.data();
                            for (var p in h) "" !== h[p] && (r += " data-" + p + '="' + h[p] + '"');
                            o + l !== "" && (s = ' class="' + o + l + '"'), i = "<li" + d + r + s + a + n + ">" + e.html() + "</li>", e.parent().is("optgroup") && (void 0 !== e.parent().attr("class") && (c = " " + e.parent().attr("class")), i = "<li" + d + r + ' class="' + o + l + " option" + c + '"' + a + n + ">" + e.html() + "</li>", e.is(":first-child") && (i = '<li class="optgroup' + c + '">' + e.parent().attr("label") + "</li>" + i)), I += i
                        }
                    }
                    if (E.is("[multiple]")) {
                        if (t || F) return;
                        ! function() {
                            var t = new M,
                                e = R('<div class="jq-select-multiple jqselect"></div>').attr({ id: t.id, title: t.title }).addClass(t.classes).data(t.data);
                            E.after(e), O(), e.append("<ul>" + I + "</ul>");
                            var i = R("ul", e),
                                s = R("li", e),
                                o = E.attr("size"),
                                n = i.outerHeight(),
                                a = s.outerHeight();
                            void 0 !== o && 0 < o ? i.css({ height: a * o }) : i.css({ height: 4 * a }), n > e.height() && (i.css("overflowY", "scroll"), A(i), s.filter(".selected").length && i.scrollTop(i.scrollTop() + s.filter(".selected").position().top)), E.prependTo(e), E.is(":disabled") ? (e.addClass("disabled"), P.each(function() { R(this).is(":selected") && s.eq(R(this).index()).addClass("selected") })) : (s.filter(":not(.disabled):not(.optgroup)").click(function(t) {
                                E.focus();
                                var e = R(this);
                                if (t.ctrlKey || t.metaKey || e.addClass("selected"), t.shiftKey || e.addClass("first"), t.ctrlKey || t.metaKey || t.shiftKey || e.siblings().removeClass("selected first"), (t.ctrlKey || t.metaKey) && (e.is(".selected") ? e.removeClass("selected first") : e.addClass("selected first"), e.siblings().removeClass("first")), t.shiftKey) {
                                    var i = !1,
                                        o = !1;
                                    e.siblings().removeClass("selected").siblings(".first").addClass("selected"), e.prevAll().each(function() { R(this).is(".first") && (i = !0) }), e.nextAll().each(function() { R(this).is(".first") && (o = !0) }), i && e.prevAll().each(function() {
                                ...
                                P.prop("selected", !1), s.filter(".selected").each(function() {
                                    var t = R(this),
                                        e = t.index();
                                    t.is(".option") && (e -= t.prevAll(".optgroup").length), P.eq(e).prop("selected", !0)
                                }), E.change()
                            }), P.each(function(t) { R(this).data("optionIndex", t) }), E.on("change.styler", function() {
                                s.removeClass("selected");
                                var e = [];
                                P.filter(":selected").each(function() { e.push(R(this).data("optionIndex")) }), s.not(".optgroup").filter(function(t) { return -1 < R.inArray(t, e) }).addClass("selected")
                        ...
                        var t = new M,
                            ...
                            o = E.data("search"),
                            s = E.data("search-limit"),
                            n = E.data("search-not-found"),
                            a = E.data("search-placeholder"),
                            l = E.data("smart-positioning");
                        void 0 === i && (i = D.selectPlaceholder), void 0 !== o && "" !== o || (o = D.selectSearch), void 0 !== s && "" !== s || (s = D.selectSearchLimit), void 0 !== n && "" !== n || (n = D.selectSearchNotFound), void 0 === a && (a = D.selectSearchPlaceholder), void 0 !== l && "" !== l || (l = D.selectSmartPositioning);
                        var c = R('<div class="jq-selectbox jqselect"><div class="jq-selectbox__select"><div class="jq-selectbox__select-text"></div><div class="jq-selectbox__trigger"><div class="jq-selectbox__trigger-arrow"></div></div></div></div>').attr({ id: t.id, title: t.title }).addClass(t.classes).data(t.data);
                        E.after(c).prependTo(c);
                        var d = c.css("z-index");
                        d = 0 < d ? d : 1;
                        var r = R("div.jq-selectbox__select", c),
                            h = R("div.jq-selectbox__select-text", c),
                            p = P.filter(":selected");
                        O(), o && (e = '<div class="jq-selectbox__search"><input type="search" autocomplete="off" placeholder="' + a + '"></div><div class="jq-selectbox__not-found">' + n + "</div>");
                        var u = R('<div class="jq-selectbox__dropdown">' + e + "<ul>" + I + "</ul></div>");
                        c.append(u);
                        var f = R("ul", u),
                            m = R("li", u),
                            g = R("input", u),
                            v = R("div.jq-selectbox__not-found", u).hide();
                        m.length < s && g.parent().hide(), "" === P.first().text() && P.first().is(":selected") && !1 !== i ? h.text(i).addClass("placeholder") : h.text(p.text());
                        var b = 0,
                            y = 0;
                        if (m.css({ display: "inline-block" }), m.each(function() {
                                var t = R(this);
                                t.innerWidth() > b && (b = t.innerWidth(), y = t.width())
                            }), m.css({ display: "" }), h.is(".placeholder") && h.width() > b) h.width(h.width());
                        else {
                            var w = c.clone().appendTo("body").width("auto"),
                                x = w.outerWidth();
                            w.remove(), x == c.outerWidth() && h.width(y)
                        }
                        b > c.width() && u.width(b), "" === P.first().text() && "" !== E.data("placeholder") && m.first().hide();
                        var _ = c.outerHeight(!0),
                            C = g.parent().outerHeight(!0) || 0,
                            S = f.css("max-height"),
                            k = m.filter(".selected");
                        if (k.length < 1 && m.first().addClass("selected sel"), void 0 === m.data("li-height")) { var T = m.outerHeight();!1 !== i && (T = m.eq(1).outerHeight()), m.data("li-height", T) }
                        var $ = u.css("top");
                        if ("auto" == u.css("left") && u.css({ left: 0 }), "auto" == u.css("top") && (u.css({ top: _ }), $ = _), u.hide(), k.length && (P.first().text() != p.text() && c.addClass("changed"), c.data("jqfs-class", k.data("jqfs-class")), c.addClass(k.data("jqfs-class"))), E.is(":disabled")) c.addClass("disabled");
                        else {
                            r.click(function() {
                                if (R("div.jq-selectbox").filter(".opened").length && D.onSelectClosed.call(R("div.jq-selectbox").filter(".opened")), E.focus(), !F) {
                                    var e = R(window),
                                        i = m.data("li-height"),
                                        o = c.offset().top,
                                    ...
                                    var n = 5 * i,
                                        a = i * t;
                                    0 < t && t < 6 && (n = a), 0 === t && (a = "auto");
                                    var r = function() {
                                        u.height("auto").css({ bottom: "auto", top: $ });

                                        function t() { f.css("max-height", Math.floor((s - 20 - C) / i) * i) }
                                        t(), f.css("max-height", a), "none" != S && f.css("max-height", S), s < u.outerHeight() + 20 && t()
                                    };
                                    !0 === l || 1 === l ? n + C + 20 < s ? (r(), c.removeClass("dropup").addClass("dropdown")) : (function() {
                                        u.height("auto").css({ top: "auto", bottom: $ });

                                        function t() { f.css("max-height", Math.floor((o - e.scrollTop() - 20 - C) / i) * i) }
                                        t(), f.css("max-height", a), "none" != S && f.css("max-height", S), o - e.scrollTop() - 20 < u.outerHeight() + 20 && t()
                                    }(), c.removeClass("dropdown").addClass("dropup")) : !1 === l || 0 === l ? n + C + 20 < s && (r(), c.removeClass("dropup").addClass("dropdown")) : (u.height("auto").css({ bottom: "auto", top: $ }), f.css("max-height", a), "none" != S && f.css("max-height", S)), c.offset().left + u.outerWidth() > e.width() && u.css({ left: "auto", right: 0 }), R("div.jqselect").css({ zIndex: d - 1 }).removeClass("opened"), c.css({ zIndex: d }), u.is(":hidden") ? (R("div.jq-selectbox__dropdown:visible").hide(), u.show(), c.addClass("opened focused"), D.onSelectOpened.call(c)) : (u.hide(), c.removeClass("opened dropup dropdown"), R("div.jq-selectbox").filter(".opened").length && D.onSelectClosed.call(c)), g.length && (g.val("").keyup(), v.hide(), g.keyup(function() {
                                        var t = R(this).val();
                                        m.each(function() { R(this).html().match(new RegExp(".*?" + t + ".*?", "i")) ? R(this).show() : R(this).hide() }), "" === P.first().text() && "" !== E.data("placeholder") && m.first().hide(), m.filter(":visible").length < 1 ? v.show() : v.hide()
                                    })), m.filter(".selected").length && ("" === E.val() ? f.scrollTop(0) : (f.innerHeight() / i % 2 != 0 && (i /= 2), f.scrollTop(f.scrollTop() + m.filter(".selected").position().top - f.innerHeight() / 2 + i))), A(f)
                                }
                            }), m.hover(function() { R(this).siblings().removeClass("selected") });
        ...
        var i, o = arguments;
        return void 0 === e || "object" == typeof e ? (this.each(function() { R.data(this, "_" + s) || R.data(this, "_" + s, new n(this, e)) }).promise().done(function() {
            var t = R(this[0]).data("_" + s);
            t && t.options.onFormStyled.call()
        }), this) : "string" == typeof e && "_" !== e[0] && "init" !== e ? (this.each(function() {
            var t = R.data(this, "_" + s);
